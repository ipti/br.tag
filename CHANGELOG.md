...
- Adicionada tela de configuração (Estoque → Configurar Alerta de Vencimento) para definir o prazo padrão de alerta do município e cadastrar grupos de alimentos com prazo próprio (ex.: Hortaliças = 15 dias); cada alimento pode pertencer a, no máximo, um grupo — os demais usam o prazo padrão
...
- Alteração na estrutura da tabela que representa as aulas dentro de um plano, modificando o tipo da coluna metodologia para que aceite textos com mais de 1500 caracteres.
