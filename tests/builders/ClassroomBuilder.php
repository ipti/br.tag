...
class ClassroomBuilder
{
    ...
    */
    ...
    public function buildCompleted()
    {
        ...
        $this->classroom['modality'] = $this->faker->randomElement([1, 2, 3, 4]);
        $this->classroom['diff_location'] = $this->faker->randomElement([0, 1, 2, 3]);
        ...
        $this->classroom['turn'] = $this->faker->randomElement(['M', 'T', 'N', 'I']);
