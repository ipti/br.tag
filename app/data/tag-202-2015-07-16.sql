...
--
-- Host: 127.0.0.1    Database: br.org.ipti.tag
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=4647 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student_identification` (
  ...
  `responsable_telephone` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `edcenso_nation_fk` (`edcenso_nation_fk`),
  KEY `edcenso_uf_fk` (`edcenso_uf_fk`),
...
-- Dump completed on 2015-07-16 10:28:06
