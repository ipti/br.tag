    ...
    <div class="widget widget-tabs border-bottom-none">
        ...
        <div class="widget-head">
            <ul class="tab-student">
                ...
                <li id="tab-student-declaration"><a class="glyphicons home" href="?r=reports/StudentsDeclarationReport&id=<?php echo $modelStudentIdentification->id ?>"><i></i><?php echo Yii::t('default', 'Declaration') ?></a></li>
            </ul>
        </div>
                                ...
                                <div class="widget-body in" style="height: auto;">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Max length: ') . '20'; ?>"><i></i></span>
