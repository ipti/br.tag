    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="buttons span6">
                <a href="<?php echo $this->createUrl('student/create');?>" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i> Alunos PNE</a>
                <a href="<?php echo $this->createUrl('wizard/configuration/student');?>" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i> Matrícula em Grupo</a>
                <a href="<?php echo $this->createUrl('student/create');?>" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i> Adicionar aluno</a>
            </div>
