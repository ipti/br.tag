...
<div class="heading-buttons">
    ...
    <h3><?php echo $title; ?><span> | <?php echo Yii::t('default', 'Campos com * são obrigatórios.') ?></span></h3>
        ...
        <div class="tab-pane active" id="school-indentify">
            <div class="row-fluid">
                ...
                <div class="span6">
                    ...
                    <div class="control-group">
                        <?php echo $form->labelEx($modelSchoolIdentification, 'Início do Ano Letivo', array('class' => 'control-label')); ?>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <?php echo $form->labelEx($modelSchoolIdentification, 'Final do Ano Letivo', array('class' => 'control-label')); ?>
                        <div class="controls">
                            <div class="input-append">
                    ...
                    <div class="control-group">
                        <?php echo $form->labelEx($modelSchoolIdentification, 'Dependência Administrativa', array('class' => 'control-label')); ?>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <?php echo $form->labelEx($modelSchoolIdentification, 'Localização', array('class' => 'control-label')); ?>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <?php echo $form->labelEx($modelSchoolIdentification, 'Regulamentação', array('class' => 'control-label')); ?>
                        <div class="controls">
            ...
            <div class="row-fluid">
                <div class=" span5">
                    ...
                    <div class="separator"></div>
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'CPF do Gestor', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Nome do Gestor', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Cargo do Gestor', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Email do Gestor', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Forma de ocupação do prédio', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Prédio compartilhado com outra escola', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Escola com a qual compartilha', array('class' => 'control-label')); ?>
                            <div class="controls">
...
(AEE)
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Numero de Salas de Aula na Escola', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Número de Salas Usadas como Sala de Aula', array('class' => 'control-label')); ?>
                            <div class="controls">
                    ...
                    <div class="tab-pane" id="school-equipament">
                        <div class="row-fluid">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Aparelho de TV', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Videocassete', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'DVD', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Antena Parabólica', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Copiadora', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Retroprojetor', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Impressora', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Aparelho de Som', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Projetor Multimídia (Data Show)', array('class' => 'control-label')); ?>
                                <div class="controls">
                        ...
                        <div class="span6">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Fax', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Máquina Fotográfica / Filmadora', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Computadores', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Quantidade de computadores de uso administrativo', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Quantidade de computadores de uso do alunos', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Acesso à Internet', array('class' => 'control-label')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Banda Larga', array('class' => 'control-label')); ?>
                                <div class="controls">
                    ...
                    <div class="tab-pane" id="school-humans">
                        <div class="row-fluid">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($modelSchoolStructure, 'Total de funcionários da escola', array('class' => 'control-label')); ?>
                                <div class="controls">
                    ...
                    <div class="tab-pane" id="school-feeding">
                        <div class="row-fluid">
                            ...
                            <div class="separator"></div>
                             ...
                             <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Alimentação escolar para os alunos', array('class' => 'control-label')); ?>
                            <div class="controls">
                    ...
                    <div class="tab-pane" id="school-education">
                        <div class="row-fluid">
                            ...
                            <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Atendimento educacional especializado (AEE)', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Atividade complementar', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Ensino fundamental organizado em circulos', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Localização diferenciada', array('class' => 'control-label')); ?>
                            <div class="controls">
                            <?php
                        ...
                        <div class="control-group">
                            <label class="control-label">Materiais didáticos específicos para atendimento à diversidade sócio-cultural</label>
                            <div class="uniformjs margin-left">
                                <label class="checkbox">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Educação indígena', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label">Lígua em que o ensino é ministrado</label>
                            <div class="uniformjs margin-left">
                                <label class="checkbox">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Língua indígena', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Escola cede espaço para turmas do Brasil Alfabetizado', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Escola abre aos finais de semana para a comunidade', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <?php echo $form->labelEx($modelSchoolStructure, 'Escola com proposta pedagógica de formação por alternância', array('class' => 'control-label')); ?>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="uniformjs margin-left">
                                ...
                                <label class="checkbox">
                                    ...
                                    Educação Especial - Ensino Médio - Normal / Magistério
                                </label>
                                <label class="checkbox">
