            ...
            <div class="panelGroupBody">
                ...
                <div class="control-group">
                    ...
                    <?php echo $form->DropDownList($model,'assistance_type',
                            array(null => 'Selecione o tipo de assistencia'),
                            array('ajax' => array(
                                'type' => 'POST', 
                ...
                <div class="control-group">
                    ...
                    <?php
                    echo $form->DropDownList($model, 'modality', array(null => 'Selecione a modalidade',
                        '1' => '(Ensino Regular)',
                ...
                <div class="control-group">
                    ...
                    <?php
                    echo $form->DropDownList($model, 'edcenso_stage_vs_modality_fk', CHtml::listData(EdcensoStageVsModality::model()->findAll(array('order' => 'name')), 'id', 'name'), array('prompt' => '(Select Stage vs Modality)'));
                    ?>
