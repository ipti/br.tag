...
<div class="innerLR home">
    ...
    <div class="row-fluid">
        <div class="span6">
            <div class="row-fluid">
                ...
                <!--                <div class="span3">-->
                <!--                    <a href="-->
                <?php //echo Yii::app()->createUrl('admin/clearDB') ?><!--" class="widget-stats">-->
    ...
    <div class="row-fluid">
        <div class="span6">
            ...
            <div class="span3">
                <a href="<?php echo Yii::app()->createUrl('admin/syncExport') ?>" id="callSyncExport"
                   class="widget-stats">
...
<!--            </div>-->
    ...
    <div id="import-file-dialog" title="<?php echo Yii::t('default', 'Import File Dialog'); ?>">
        <div class="row-fluid">
            <div class="span12">
                <form id="import-file-form" method="post" action="<?php echo CController::createUrl('admin/import'); ?>"
