...
class IptimoduleCode extends CCodeModel
{
    public $moduleID;
...
return array(
    'urlManager' => array(
        'rules' => array(
            'name-used-to-access-the-module/'                          => '{$this->moduleID}/',
            'name-used-to-access-the-module/<action:\w+>'              => '{$this->moduleID}/default/<action>',
            'name-used-to-access-the-module/<action:\w+>/<eid:\d+>'    => '{$this->moduleID}/default/<action>',
        ),
    ),
