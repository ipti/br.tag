...
INSERT into edcenso_stage_vs_modality (name, stage) values ('Complementação Educacional', ?);
INSERT into edcenso_stage_vs_modality (name, stage) values ('Ensino Médio Integrado A Educação Profissional', ?);