...
ALTER TABLE grade_results
    ...
    CHANGE COLUMN  rec_partial_1 rec_bim_1 float NULL,
    CHANGE COLUMN  rec_partial_2 rec_bim_2 float NULL,
    CHANGE COLUMN  rec_partial_3 rec_bim_3 float NULL,
    CHANGE COLUMN  rec_partial_4 rec_bim_4 float NULL,
    CHANGE COLUMN  rec_partial_5 rec_bim_5 float NULL,
    CHANGE COLUMN  rec_partial_6 rec_bim_6 float NULL,
    CHANGE COLUMN  rec_partial_7 rec_bim_7 float NULL,
    CHANGE COLUMN  rec_partial_8 rec_bim_8 float NULL,
    CHANGE COLUMN  rec_partial_9 rec_sem_1 float NULL,
    CHANGE COLUMN  rec_partial_10 rec_sem_2 float NULL,
    CHANGE COLUMN  rec_partial_11 rec_sem_3 float NULL,
    CHANGE COLUMN  rec_partial_12 rec_sem_4 float NULL;
