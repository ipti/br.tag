...
class GradeCalculation extends TagModel
{
    ...
    public function relations()
    {
        ...
        return [
            'gradePartialRecoveries' => [self::HAS_MANY, 'GradePartialRecovery', 'grade_calculation_fk'],
            'gradeRules' => [self::HAS_MANY, 'GradeRules', 'grade_calculation_fk'],
            'gradeUnities' => [self::HAS_MANY, 'GradeUnity', 'grade_calculation_fk'],
        ];
    }
