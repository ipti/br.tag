...
class EdcensoRegionalEducationOrgan extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['edcenso_city_fk, code, name, edcenso_uf_fk', 'required'],
            ['edcenso_city_fk, edcenso_uf_fk', 'numerical', 'integerOnly' => true],
            ['code', 'length', 'max' => 5],
            ['name', 'length', 'max' => 100],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, edcenso_city_fk, code, name, edcenso_uf_fk', 'safe', 'on' => 'search'],
        ];
    }
