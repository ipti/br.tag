...
class Grade extends TagModel
{
    ...
    public function relations()
    {
        ...
        return [
            'gradePartialRecoveryFk' => [self::BELONGS_TO, 'GradePartialRecovery', 'grade_partial_recovery_fk'],
            'gradeUnityModalityFk' => [self::BELONGS_TO, 'GradeUnityModality', 'grade_unity_modality_fk'],
            'disciplineFk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_fk'],
            'gradeConceptFk' => [self::BELONGS_TO, 'GradeConcept', 'grade_concept_fk'],
        ];
    }
