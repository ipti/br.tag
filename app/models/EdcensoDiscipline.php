...
class EdcensoDiscipline extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return [
            'instructorTeachingDatas' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_10_fk'],
            'instructorTeachingDatas1' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_11_fk'],
            'instructorTeachingDatas2' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_12_fk'],
            'instructorTeachingDatas3' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_13_fk'],
            'instructorTeachingDatas4' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_2_fk'],
            'instructorTeachingDatas5' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_3_fk'],
            'instructorTeachingDatas6' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_4_fk'],
            'instructorTeachingDatas7' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_5_fk'],
            'instructorTeachingDatas8' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_6_fk'],
            'instructorTeachingDatas9' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_7_fk'],
            'instructorTeachingDatas10' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_8_fk'],
            'instructorTeachingDatas11' => [self::HAS_MANY, 'InstructorTeachingData', 'discipline_9_fk'],
        ];
    }
