...
class InstructorVariableData extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('high_education_institution_type_1',$this->high_education_institution_type_1);
		...
		$criteria->compare('high_education_institution_type_2',$this->high_education_institution_type_2);
		...
		$criteria->compare('high_education_institution_type_3',$this->high_education_institution_type_3);
