 ...
 * @property integer $other_courses_full_time_education
...
class InstructorVariableData extends AltActiveRecord
{
    ...
    public function relations()
    {
        ...
        return [
            'highEducationCourseCode1Fk' => [self::BELONGS_TO, 'EdcensoCourseOfHigherEducation', 'high_education_course_code_1_fk'],
            'highEducationInstitutionCode1Fk' => [self::BELONGS_TO, 'EdcensoIES', 'high_education_institution_code_1_fk'],
            'highEducationCourseCode2Fk' => [self::BELONGS_TO, 'EdcensoCourseOfHigherEducation', 'high_education_course_code_2_fk'],
            'highEducationInstitutionCode2Fk' => [self::BELONGS_TO, 'EdcensoIES', 'high_education_institution_code_2_fk'],
            'highEducationCourseCode3Fk' => [self::BELONGS_TO, 'EdcensoCourseOfHigherEducation', 'high_education_course_code_3_fk'],
            'highEducationInstitutionCode3Fk' => [self::BELONGS_TO, 'EdcensoIES', 'high_education_institution_code_3_fk'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'other_courses_full_time_education' => Yii::t('default', 'Other Courses Full Time Education'),
