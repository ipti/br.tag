...
class StudentEnrollment extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('school_inep_id_fk, student_fk, classroom_fk,another_scholarization_place, public_transport, school_admission_date, current_stage_situation, previous_stage_situation, admission_type', 'required'),
