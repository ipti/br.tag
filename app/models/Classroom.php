...
class Classroom extends AltActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'studentEnrollments' => array(self::HAS_MANY, 'StudentEnrollment', 'classroom_fk', 'order' => 'daily_order ASC', 'join' => 'JOIN student_identification ON student_identification.id=studentEnrollments.student_fk'),
        );
    }
