...
class Classroom extends AltActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'statusFk' => array(self::BELONGS_TO, 'ClassroomStatus', 'classroom_status'),
