...
class StudentEnrollmentHistory extends TagModel
{
	...
	public function rules()
	{
		...
		return array(
			array('student_enrollment_fk, status', 'required'),
			array('student_enrollment_fk, status', 'numerical', 'integerOnly'=>true),
			array('enrollment_date, transfer_date, class_transfer_date, school_readmission_date, created_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, student_enrollment_fk, status, enrollment_date, transfer_date, class_transfer_date, school_readmission_date, created_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'studentEnrollmentFk' => array(self::BELONGS_TO, 'StudentEnrollment', 'student_enrollment_fk'),
		);
	}
