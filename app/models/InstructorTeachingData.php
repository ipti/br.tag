...
class InstructorTeachingData extends AltActiveRecord
{
    ...
    public function relations()
    {
        return [
            ...
            'discipline1Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_1_fk'],
            'schoolInepIdFk' => [self::BELONGS_TO, 'SchoolIdentification', 'school_inep_id_fk'],
            'discipline10Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_10_fk'],
            'discipline11Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_11_fk'],
            'discipline12Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_12_fk'],
            'discipline13Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_13_fk'],
            'discipline2Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_2_fk'],
            'discipline3Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_3_fk'],
            'discipline4Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_4_fk'],
            'discipline5Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_5_fk'],
            'discipline6Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_6_fk'],
            'discipline7Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_7_fk'],
            'discipline8Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_8_fk'],
            'discipline9Fk' => [self::BELONGS_TO, 'EdcensoDiscipline', 'discipline_9_fk'],
