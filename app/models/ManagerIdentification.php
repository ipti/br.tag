...
class ManagerIdentification extends TagModel
{
    ...
    {
        return [
            ['school_inep_id_fk, name, birthday_date, sex, color_race, nationality, residence_zone, filiation, edcenso_nation_fk', 'required'],
            ['sex, color_race, nationality, role, residence_zone, contract_type, filiation, filiation_1_scholarity, filiation_2_scholarity, edcenso_nation_fk, edcenso_uf_fk, edcenso_city_fk, users_fk', 'numerical', 'integerOnly' => true],
            ['register_type', 'length', 'max' => 2],
            ['school_inep_id_fk', 'length', 'max' => 8],
            ['inep_id', 'length', 'max' => 12],
            ['name, email, access_criterion, filiation_1, filiation_2', 'length', 'max' => 100],
            ['birthday_date', 'length', 'max' => 10],
            ['cpf, filiation_1_cpf, filiation_2_cpf', 'length', 'max' => 11],
            ['number_ato', 'length', 'max' => 30],
            ['filiation_1_rg, filiation_1_job, filiation_2_rg, filiation_2_job', 'length', 'max' => 45],
            ['register_type, id, school_inep_id_fk, inep_id, name, email, birthday_date, sex, color_race, nationality, role, residence_zone, access_criterion, contract_type, cpf, number_ato, filiation, filiation_1, filiation_2, filiation_1_rg, filiation_1_cpf, filiation_1_scholarity, filiation_1_job, filiation_2_rg, filiation_2_cpf, filiation_2_scholarity, filiation_2_job, edcenso_nation_fk, edcenso_uf_fk, edcenso_city_fk, users_fk', 'safe', 'on' => 'search'],
        ];
    }
