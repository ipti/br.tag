 ...
 * @property int $course_class_resource_fk
...
class CourseClassHasClassResource extends TagModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['course_class_fk, course_class_resource_fk', 'required'],
            ['course_class_fk, course_class_resource_fk', 'numerical', 'integerOnly' => true],
    ...
    public function relations()
    {
        ...
        return [
            'courseClassResourceFk' => [self::BELONGS_TO, 'CourseClassResources', 'course_class_resource_fk'],
