...
class EdcensoNation extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return [
            'instructorIdentifications' => [self::HAS_MANY, 'InstructorIdentification', 'edcenso_nation_fk'],
            'studentIdentifications' => [self::HAS_MANY, 'StudentIdentification', 'edcenso_nation_fk'],
        ];
    }
