...
class EdcensoDistrict extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['edcenso_city_fk, code, name', 'required'],
            ['edcenso_city_fk, code', 'numerical', 'integerOnly' => true],
            ['name', 'length', 'max' => 50],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, edcenso_city_fk, code, name', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function relations()
    {
        ...
        return [
            ...
            'schoolIdentifications' => [self::HAS_MANY, 'SchoolIdentification', 'edcenso_district_fk'],
        ];
    }
