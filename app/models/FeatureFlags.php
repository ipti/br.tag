...
class FeatureFlags extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('feature_name, updated_at', 'required'),
			array('active', 'numerical', 'integerOnly'=>true),
			array('feature_name', 'length', 'max'=>64),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('feature_name, active, updated_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'featureName' => array(self::BELONGS_TO, 'AuthItem', 'feature_name'),
		);
	}
