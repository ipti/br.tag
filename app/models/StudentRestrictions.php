 ...
 */
class StudentRestrictions extends TagModel
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ['student_fk, celiac, diabetes, hypertension, iron_deficiency_anemia, sickle_cell_anemia, lactose_intolerance, malnutrition, obesity', 'required'],
