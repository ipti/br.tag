...
class SagresConsultModel
{
    ...
    public function getClasses($inepId, $referenceYear, $month, $finalClass,$withoutCpf)
    {
        ...
        foreach ($turmas as $turma) {
            ...
            $classType
                ...
                ->setMatricula($this->getEnrollments($classId, $referenceYear, $month, $finalClass, $withoutCpf))
     ...
     */
    public function getEnrollments($classId, $referenceYear, $month, $finalClass, $withoutCpf)
    {
        $enrollmentList = [];
        $strMaxLength = 200;
        $strlen = 5;
