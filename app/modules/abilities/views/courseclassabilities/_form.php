    ...
    <div class="main">
        ...
        <div class="row">
            <div class="t-field-text column is-two-fifths">
                ...
                <?php echo $form->textField($model, 'description', ['size' => 60, 'maxlength' => 1500, 'class' => 't-field-text__input']); ?>
                <?php echo $form->error($model, 'description'); ?>
            </div>

            <div class="t-field-text column is-two-fifths">
                <?php echo $form->labelEx($model, 'code', ['class' => 't-field-text__label']); ?>
                <?php echo $form->textField($model, 'code', ['size' => 20, 'maxlength' => 20, 'class' => 't-field-text__input', 'required' => 'required']); ?>
                <?php echo $form->error($model, 'code'); ?>
            </div>
        </div>
        <div class="row">
            <div class="t-field-text column is-two-fifths">
                <?php echo $form->labelEx($model, 'edcenso_discipline_fk', ['class' => 't-field-text__label']); ?>
                <?php echo $form->dropDownList(
        $model,
        'edcenso_discipline_fk',
        CHtml::listData(EdcensoDiscipline::model()->findAll(['order' => 'name']), 'id', 'name'),
        [
            'key' => 'id',
        ...
        <div class="row reverse show--tablet">
          <div class="t-buttons-container">
            <div class="column clearfix">
                 <?php echo CHtml::submitButton($model->isNewRecord ? 'Criar' : 'Salvar', ['class' => 't-button-primary']); ?>
            </div>
          </div>
        </div>
    </div>
