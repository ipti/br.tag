    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="t-buttons-container">
                <a class="t-button-primary" rel="noopener" href="<?php echo Yii::app()->createUrl('classroom/default/create') ?>"> Adicionar
                    turma</a>
                <div class="mobile-row">
                    <a class="t-button-secondary"
                       href="<?php echo Yii::app()->createUrl('schoolreport/reports/numberstudentsperclassroomreport') ?>"
                       target="_blank" rel="noopener">Relatório Alunos/Turma</a>
                    <a class="t-button-secondary"
                       href="<?php echo Yii::app()->createUrl('schoolreport/reports/instructorsperclassroomreport') ?>"
    ...
    <div class="tag-inner">
        <div class="btn-group pull-right responsive-menu">
            ...
            <ul class="dropdown-menu">
                <li><a href="<?php echo Yii::app()->createUrl('classroom/default/create') ?>" class=""><i></i> Adicionar
                        turma</a></li>
                <li><a href="<?php echo Yii::app()->createUrl('schoolreport/reports/numberstudentsperclassroomreport') ?>"
                       class=""><i></i>Relatório Alunos/Turma</a></li>
                <li><a href="<?php echo Yii::app()->createUrl('schoolreport/reports/instructorsperclassroomreport') ?>"
                ...
                <div class="widget-body">
                    ...
                    array_push($columns,
                        array(
                            'name' => 'name',
                            'type' => 'raw',
                            'value' => 'CHtml::link($data->name,Yii::app()->createUrl("classroom/default/update",array("id"=>$data->id)))',
                        ...
                        array_push($columns,
                            array(
                                ...
                                'buttons' => array(
                                    ...
                                    'unsync' => array(
                                        'url' => 'Yii::app()->createUrl("classroom/default/syncToSedsp",array("id"=>$data->id))',
