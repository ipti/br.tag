    ...
    <div class="column clearleft">
        ...
        if (!$modelClassroom->isNewRecord && Yii::app()->features->isEnable(TFeature::FEAT_INTEGRATIONS_SEDSP)) {
            ...
            <div style="display: flex;align-items: center;margin-right: 10px;margin-top: 13px;">
                ...
                <?php } else { ?>
                    <div style="font-weight: bold;margin-right: 20px;">
                        <img src="<?= Yii::app()->theme->baseUrl; ?>/img/notSync.png" style="width: 25px;margin-right: 2px;">Não
                        sincronizado
                    </div>
                <?php } ?>
        ...
        <div class="widget-body form-horizontal">
            ...
            <div class="tab-content form-content">
                        ...
                        <div class="column">
                            ...
                            <div class="t-field-select" id="stage_vs_modality">
                                ...
                                <img class="loading-disciplines" style="display:none;position: fixed;margin: 5px 20px;"
                                    ...
                                    src="<?= Yii::app()->theme->baseUrl; ?>/img/loadingTag.gif" alt="TAG Loading">
                            </div>
                            ...
                            <div class="t-field-checkbox-group" id="prosic-container"
                                style="<?= (isset($modelClassroom->edcensoStageVsModalityFk) && TagUtils::isMultiStage($modelClassroom->edcensoStageVsModalityFk->edcenso_associated_stage_id)) ? '' : 'display:none;' ?>">
                                <label class="t-field-checkbox__label">
                            ...
                            ?>
                            <div class="t-field-select" id="turma-alternancia-container"
                                style="<?= $turmaAlternanciaVisible ? '' : 'display:none;' ?>">
                            ...
                            <div class="t-field-select">
                                ...
                                echo $form->DropDownList(
                                    ...
                                    array(
                                        ...
                                        'ajax' => array(
                                            'type' => 'POST',
                                            'url' => Yii::app()->createUrl('classroom/default/updateTime'),
                        ...
                        <div class="column">
                            ...
                            <div class="t-field-select">
                                ...
                                <select class="select-search-on t-field-select__input select2-container"
                                    name="calendar_fk" id="Calendars"
                                    selectedOption="<?= $modelClassroom->calendar_fk ?>">
                    ...
                    <div class="row-fluid">
                                ...
                                <div class="reports">
                                    <div class="reports_cards" style="display: none;">
                                        <a class="t-button-primary" rel="noopener"
                                            href="<?= @Yii::app()->createUrl('grades/default/ClassClosure', array('classroomId' => $modelClassroom->id)); ?>">
                                    ...
                                    <?php if (TagUtils::isInstance("BUZIOS")): ?>
                                        <div class="reports_cards">
                                            <a class="t-button-secondary" rel="noopener" target="_blank"
                                                href="<?= @Yii::app()->createUrl('classroom/default/batchupdatenrollment', array('id' => $modelClassroom->id)); ?>">
                                    ...
                                    <div class="reports_cards">
                                        <a class="t-button-secondary" rel="noopener" target="_blank"
                                            href="<?= @Yii::app()->createUrl('classroom/default/batchupdatetransport', array('id' => $modelClassroom->id)); ?>">
                                    ...
                                    <div class="reports_cards">
                                        <a class="t-button-secondary" rel="noopener" target="_blank"
                                            href="<?= Yii::app()->createUrl('classroom/default/batchupdatetotal', array('id' => $modelClassroom->id)) ?>">
                                            <!-- <img alt="impressora" src="<?= Yii::app()->theme->baseUrl; ?>/img/Impressora.svg" class="img_cards" /> -->
                                            <span class="t-icon-printer"></span>
                                    ...
                                    <div class="reports_cards">
                                        <a class="t-button-secondary" rel="noopener" target="_blank"
                                            href="<?= Yii::app()->createUrl('schoolreport/reports/enrollmentperclassroomreport', array('id' => $modelClassroom->id)) ?>">
                                            <!-- <img alt="impressora" src="<?= Yii::app()->theme->baseUrl; ?>/img/Impressora.svg" class="img_cards" /> -->
                                            <span class="t-icon-printer"></span>
                                    ...
                                    <div class="reports_cards">
                                        <a class="t-button-secondary" rel="noopener" target="_blank"
                                            href="<?= Yii::app()->createUrl('schoolreport/reports/studentperclassroom', array('id' => $modelClassroom->id)) ?>">
                                            <!-- <img alt="impressora" src="<?= Yii::app()->theme->baseUrl; ?>/img/Impressora.svg" class="img_cards" /> -->
                                            <span class="t-icon-printer"></span>
                                    ...
                                    <div class="reports_cards">
                                        <a class="t-button-secondary" rel="noopener" target="_blank"
                                            href="<?= Yii::app()->createUrl('schoolreport/forms/StudentsFileForm', array('classroomId' => $modelClassroom->id, 'type' => 1)) ?>">
                                            <!-- <img alt="impressora" src="<?= Yii::app()->theme->baseUrl; ?>/img/Impressora.svg" class="img_cards" /> -->
                                            <span class="t-icon-printer"></span>
                                    ...
                                    <div class="reports_cards">
                                        <a class="t-button-secondary" rel="noopener" target="_blank"
                                            href="<?= Yii::app()->createUrl('schoolreport/forms/AtaSchoolPerformance', array('id' => $modelClassroom->id)) ?>">
                                            <!-- <img alt="impressora" src="<?= Yii::app()->theme->baseUrl; ?>/img/Impressora.svg" class="img_cards" /> -->
                                            <span class="t-icon-printer"></span>
                                    ...
                                    <?php if (Yii::app()->features->isEnable(TFeature::FEAT_INTEGRATIONS_SEDSP) && count($modelEnrollments) > 0): ?>
                                        <div class="reports_cards">
                                            ...
                                            <img class="loading-sync" style="display:none;margin: 10px 20px;" height="30px"
                                                width="30px" src="<?= Yii::app()->theme->baseUrl; ?>/img/loadingTag.gif"
                                                alt="TAG Loading">
                                        </div>
                                    <?php endif ?>
                                </div>
                        ...
                        <div class="btn-group pull-right responsive-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<?= Yii::app()->createUrl('classroom/default/batchupdatenrollment', array('id' => $modelClassroom->id)) ?>"
                                        target="blank" class="hidden-print"><i></i>
                                        <?= Yii::t('default', 'Sinalizar Rematricula') ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= Yii::app()->createUrl('classroom/default/batchupdatetransport', array('id' => $modelClassroom->id)) ?>"
                                        target="blank" class="hidden-print"><i></i>
                                        <?= Yii::t('default', 'Atualizar transporte') ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= Yii::app()->createUrl('classroom/default/batchupdatetotal', array('id' => $modelClassroom->id)) ?>"
                                        target="blank" class="hidden-print"><i></i>
                                        <?= Yii::t('default', 'Atualização em Lote') ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= Yii::app()->createUrl('schoolreport/reports/enrollmentperclassroomreport', array('id' => $modelClassroom->id)) ?>"
                                        target="blank" class="hidden-print"><i></i>
                                        <?= Yii::t('default', 'Relatório de Matrícula') ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= Yii::app()->createUrl('schoolreport/reports/studentperclassroom', array('id' => $modelClassroom->id)) ?>"
                                        target="blank" class="hidden-print"><i></i>
                                        <?= Yii::t('default', 'Lista de Alunos') ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= Yii::app()->createUrl('schoolreport/forms/StudentsFileForm', array('classroomId' => $modelClassroom->id, 'type' => 1)) ?>"
                                        target="blank" class="hidden-print"><i></i>
                                        <?= Yii::t('default', 'Fichas de Matrícula') ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= Yii::app()->createUrl('schoolreport/forms/AtaSchoolPerformance', array('id' => $modelClassroom->id)) ?>"
                                        target="blank" class="hidden-print"><i></i>
                                        <?= Yii::t('default', 'Ata de Notas') ?>
                                    </a>
                                </li>
                                    ...
                                    if (count($modelEnrollments) > 0):
                                        ...
                                        foreach ($modelEnrollments as $enrollment): ?>
                                            <tr>
                                                ...
                                                <?php endif ?>
                                                <td width="140">
                                                    <a href="<?= @Yii::app()->createUrl('schoolreport/forms/StudentFileForm', array('type' => $type, 'enrollment_id' => $enrollment["enrollmentId"])); ?>"
                                                        target="_blank" rel="noopener"> <i class="fa fa-eye"
                                                            style="color:#3F45EA; "></i>
                                                        Ficha de Matrícula
                                                    </a>
                                                </td>
                                            </tr>
                ...
                <div class="tab-pane" id="daily">
                    <div class="row">
                        <button id="js-alphabetic-order" type="button" class="t-button-secondary"><span
                                class="t-icon-arrow-az"></span>Ordem Alfabética</button>
                    </div>
...
<script type="text/javascript">
    ...
    var getAssistanceURL = '<?= Yii::app()->createUrl('classroom/default/getassistancetype') ?>';
    var jsonCompActv = '<?= json_encode($complementaryActivities); ?>';
    var updateLessonUrl = '<?= Yii::app()->createUrl('classroom/default/updateLesson'); ?>';
    var addLessonUrl = '<?= Yii::app()->createUrl('classroom/default/addLesson'); ?>';
    var deleteLessonUrl = '<?= Yii::app()->createUrl('classroom/default/deleteLesson'); ?>';
