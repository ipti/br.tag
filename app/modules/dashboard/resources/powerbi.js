...
/***/ (function (__unused_webpack_module, exports, __nested_webpack_require_612__) {
                                    ...
                                    var NotSupportedFilter = /** @class */ (function (_super) {
                                        ...
                                        function NotSupportedFilter(target, message, notSupportedTypeName) {
                                            let _this = _super.call(this, target, FilterType.Unknown) || this;
                                        ...
                                        NotSupportedFilter.prototype.toJSON = function () {
                                            let filter = _super.prototype.toJSON.call(this);
                                    ...
                                    var IncludeExcludeFilter = /** @class */ (function (_super) {
                                        ...
                                        function IncludeExcludeFilter(target, isExclude, values) {
                                            let _this = _super.call(this, target, FilterType.IncludeExclude) || this;
                                            _this.values = values;
                                    ...
                                    var TopNFilter = /** @class */ (function (_super) {
                                        ...
                                        function TopNFilter(target, operator, itemCount, orderBy) {
                                            let _this = _super.call(this, target, FilterType.TopN) || this;
                                    ...
                                    var RelativeDateFilter = /** @class */ (function (_super) {
                                        ...
                                        function RelativeDateFilter(target, operator, timeUnitsCount, timeUnitType, includeToday) {
                                            let _this = _super.call(this, target, FilterType.RelativeDate) || this;
                                            _this.operator = operator;
                                    ...
                                    var RelativeTimeFilter = /** @class */ (function (_super) {
                                        ...
                                        function RelativeTimeFilter(target, operator, timeUnitsCount, timeUnitType) {
                                            let _this = _super.call(this, target, FilterType.RelativeTime) || this;
                                            _this.operator = operator;
                                            _this.timeUnitsCount = timeUnitsCount;
                                            _this.timeUnitType = timeUnitType;
                                    ...
                                    var BasicFilter = /** @class */ (function (_super) {
                                        ...
                                        function BasicFilter(target, operator) {
                                            ...
                                            let _this = _super.call(this, target, FilterType.Basic) || this;
                                            _this.operator = operator;
                                    ...
                                    var BasicFilterWithKeys = /** @class */ (function (_super) {
                                        ...
                                        function BasicFilterWithKeys(target, operator, values, keyValues) {
                                            let _this = _super.call(this, target, operator, values) || this;
                                            ...
                                            for (var _i = 0, _a = _this.keyValues; _i < _a.length; _i++) {
                                                let keyValue = _a[_i];
                                                if (keyValue) {
                                                    let lengthOfArray = keyValue.length;
                                    ...
                                    var IdentityFilter = /** @class */ (function (_super) {
                                        ...
                                        function IdentityFilter(target, operator) {
                                            let _this = _super.call(this, target, FilterType.Identity) || this;
                                            _this.operator = operator;
                                    ...
                                    var TupleFilter = /** @class */ (function (_super) {
                                        ...
                                        function TupleFilter(target, operator, values) {
                                            let _this = _super.call(this, target, FilterType.Tuple) || this;
                                            _this.operator = operator;
                                    ...
                                    var AdvancedFilter = /** @class */ (function (_super) {
                                        ...
                                        function AdvancedFilter(target, logicalOperator) {
                                            ...
                                            let _this = _super.call(this, target, FilterType.Advanced) || this;
                                    ...
                                    var HierarchyFilter = /** @class */ (function (_super) {
                                        ...
                                        function HierarchyFilter(target, hierarchyData) {
                                            let _this = _super.call(this, target, FilterType.Hierarchy) || this;
                                    ...
                                    var PageSelector = /** @class */ (function (_super) {
                                        ...
                                        function PageSelector(pageName) {
                                            let _this = _super.call(this, PageSelector.schemaUrl) || this;
                                            _this.pageName = pageName;
                                            return _this;
                                        }
                                        PageSelector.prototype.toJSON = function () {
                                            let selector = _super.prototype.toJSON.call(this);
                                    ...
                                    var VisualSelector = /** @class */ (function (_super) {
                                        ...
                                        function VisualSelector(visualName) {
                                            let _this = _super.call(this, VisualSelector.schemaUrl) || this;
                                    ...
                                    function validateVisualSelector(input) {
                                        let errors = validator_1.Validators.visualSelectorValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateVisualSelector = validateVisualSelector;
                                    function validateSlicer(input) {
                                        let errors = validator_1.Validators.slicerValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateSlicer = validateSlicer;
                                    function validateSlicerState(input) {
                                        let errors = validator_1.Validators.slicerStateValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateSlicerState = validateSlicerState;
                                    function validatePlayBookmarkRequest(input) {
                                        let errors = validator_1.Validators.playBookmarkRequestValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validatePlayBookmarkRequest = validatePlayBookmarkRequest;
                                    function validateAddBookmarkRequest(input) {
                                        let errors = validator_1.Validators.addBookmarkRequestValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateAddBookmarkRequest = validateAddBookmarkRequest;
                                    function validateApplyBookmarkByNameRequest(input) {
                                        let errors = validator_1.Validators.applyBookmarkByNameRequestValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateApplyBookmarkByNameRequest = validateApplyBookmarkByNameRequest;
                                    function validateApplyBookmarkStateRequest(input) {
                                        let errors = validator_1.Validators.applyBookmarkStateRequestValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateApplyBookmarkStateRequest = validateApplyBookmarkStateRequest;
                                    function validateCaptureBookmarkRequest(input) {
                                        let errors = validator_1.Validators.captureBookmarkRequestValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateCaptureBookmarkRequest = validateCaptureBookmarkRequest;
                                    function validateSettings(input) {
                                        let errors = validator_1.Validators.settingsValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateSettings = validateSettings;
                                    function validatePanes(input) {
                                        let errors = validator_1.Validators.reportPanesValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validatePanes = validatePanes;
                                    function validateBookmarksPane(input) {
                                        let errors = validator_1.Validators.bookmarksPaneValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateBookmarksPane = validateBookmarksPane;
                                    function validateFiltersPane(input) {
                                        let errors = validator_1.Validators.filtersPaneValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateFiltersPane = validateFiltersPane;
                                    function validateFieldsPane(input) {
                                        let errors = validator_1.Validators.fieldsPaneValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateFieldsPane = validateFieldsPane;
                                    function validatePageNavigationPane(input) {
                                        let errors = validator_1.Validators.pageNavigationPaneValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validatePageNavigationPane = validatePageNavigationPane;
                                    function validateSelectionPane(input) {
                                        let errors = validator_1.Validators.selectionPaneValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateSelectionPane = validateSelectionPane;
                                    function validateSyncSlicersPane(input) {
                                        let errors = validator_1.Validators.syncSlicersPaneValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateSyncSlicersPane = validateSyncSlicersPane;
                                    function validateVisualizationsPane(input) {
                                        let errors = validator_1.Validators.visualizationsPaneValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateVisualizationsPane = validateVisualizationsPane;
                                    function validateCustomPageSize(input) {
                                        let errors = validator_1.Validators.customPageSizeValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateCustomPageSize = validateCustomPageSize;
                                    function validateExtension(input) {
                                        let errors = validator_1.Validators.extensionValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateExtension = validateExtension;
                                    function validateMenuGroupExtension(input) {
                                        let errors = validator_1.Validators.menuGroupExtensionValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateMenuGroupExtension = validateMenuGroupExtension;
                                    function validateReportLoad(input) {
                                        let errors = validator_1.Validators.reportLoadValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateReportLoad = validateReportLoad;
                                    function validatePaginatedReportLoad(input) {
                                        let errors = validator_1.Validators.paginatedReportLoadValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validatePaginatedReportLoad = validatePaginatedReportLoad;
                                    function validateCreateReport(input) {
                                        let errors = validator_1.Validators.reportCreateValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateCreateReport = validateCreateReport;
                                    function validateQuickCreate(input) {
                                        let errors = validator_1.Validators.quickCreateValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateQuickCreate = validateQuickCreate;
                                    function validateDashboardLoad(input) {
                                        let errors = validator_1.Validators.dashboardLoadValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateDashboardLoad = validateDashboardLoad;
                                    function validateTileLoad(input) {
                                        let errors = validator_1.Validators.tileLoadValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateTileLoad = validateTileLoad;
                                    function validatePage(input) {
                                        let errors = validator_1.Validators.pageValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validatePage = validatePage;
                                    function validateFilter(input) {
                                        let errors = validator_1.Validators.filterValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateFilter = validateFilter;
                                    function validateUpdateFiltersRequest(input) {
                                        let errors = validator_1.Validators.updateFiltersRequestValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateUpdateFiltersRequest = validateUpdateFiltersRequest;
                                    function validateSaveAsParameters(input) {
                                        let errors = validator_1.Validators.saveAsParametersValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateSaveAsParameters = validateSaveAsParameters;
                                    function validateLoadQnaConfiguration(input) {
                                        let errors = validator_1.Validators.loadQnaValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateLoadQnaConfiguration = validateLoadQnaConfiguration;
                                    function validateQnaInterpretInputData(input) {
                                        let errors = validator_1.Validators.qnaInterpretInputDataValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateQnaInterpretInputData = validateQnaInterpretInputData;
                                    function validateExportDataRequest(input) {
                                        let errors = validator_1.Validators.exportDataRequestValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateExportDataRequest = validateExportDataRequest;
                                    function validateVisualHeader(input) {
                                        let errors = validator_1.Validators.visualHeaderValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateVisualHeader = validateVisualHeader;
                                    function validateVisualSettings(input) {
                                        let errors = validator_1.Validators.visualSettingsValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateVisualSettings = validateVisualSettings;
                                    function validateCommandsSettings(input) {
                                        let errors = validator_1.Validators.commandsSettingsValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateCommandsSettings = validateCommandsSettings;
                                    function validateCustomTheme(input) {
                                        let errors = validator_1.Validators.customThemeValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateCustomTheme = validateCustomTheme;
                                    function validateZoomLevel(input) {
                                        let errors = validator_1.Validators.zoomLevelValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
                                    exports.validateZoomLevel = validateZoomLevel;
                                    function validatePrintSettings(input) {
                                        let errors = validator_1.Validators.printSettingsValidator.validate(input);
                                        return errors ? errors.map(normalizeError) : undefined;
                                    }
...
/***/ (function (__unused_webpack_module, exports, __nested_webpack_require_63052__) {
                                    ...
                                    var ReportBarsValidator = /** @class */ (function (_super) {
                                        ...
                                        ReportBarsValidator.prototype.validate = function (input, path, field) {
                                            ...
                                            let errors = _super.prototype.validate.call(this, input, path, field);
                                            if (errors) {
                                                return errors;
                                            }
                                            let fields = [
                                            ...
                                            let multipleFieldsValidator = new multipleFieldsValidator_1.MultipleFieldsValidator(fields);
...
/***/ ((__unused_webpack_module, exports) => {
                                    ...
                                    var MultipleFieldsValidator = /** @class */ (function () {
                                        ...
                                        MultipleFieldsValidator.prototype.validate = function (input, path, field) {
                                            ...
                                            let fieldsPath = path ? path + "." + field : field;
                                            for (var _i = 0, _a = this.fieldValidatorsPairs; _i < _a.length; _i++) {
                                                let fieldValidators = _a[_i];
                                                for (var _b = 0, _c = fieldValidators.validators; _b < _c.length; _b++) {
                                                    let validator = _c[_b];
                                                    let errors = validator.validate(input[fieldValidators.field], fieldsPath, fieldValidators.field);
                                                    if (errors) {
                                                        return errors;
                                                    }
                                                }
...
/***/ (function (__unused_webpack_module, exports) {
                                    ...
                                    var ArrayValidator = /** @class */ (function () {
                                        ...
                                        ArrayValidator.prototype.validate = function (input, path, field) {
                                            ...
                                            for (var i = 0; i < input.length; i++) {
                                                let fieldsPath = (path ? path + "." : "") + field + "." + i.toString();
                                    ...
                                    var SchemaValidator = /** @class */ (function (_super) {
                                        ...
                                        function SchemaValidator(schemaValue) {
                                            let _this = _super.call(this, [schemaValue]) || this;
                                    ...
                                    var EnumValidator = /** @class */ (function (_super) {
                                        ...
                                        EnumValidator.prototype.validate = function (input, path, field) {
                                            ...
                                            let valueValidator = new ValueValidator(this.possibleValues);
...
/***/ (function (__unused_webpack_module, exports, __nested_webpack_require_157149__) {
                                    ...
                                    var PageViewFieldValidator = /** @class */ (function (_super) {
                                        ...
                                        PageViewFieldValidator.prototype.validate = function (input, path, field) {
                                            ...
                                            let possibleValues = ["actualSize", "fitToWidth", "oneColumn"];
                                    ...
                                    var AnyOfValidator = /** @class */ (function () {
                                        ...
                                        AnyOfValidator.prototype.validate = function (input, path, field) {
                                            ...
                                            for (var _i = 0, _a = this.validators; _i < _a.length; _i++) {
                                                let validator = _a[_i];
                                                let errors = validator.validate(input, path, field);
                                                if (!errors) {
                                                    valid = true;
                                                    break;
                                                }
                                        ...
                                        MapValidator.prototype.validate = function (input, path, field) {
                                            ...
                                            for (var key in input) {
                                                if (input.hasOwnProperty(key)) {
                                                    let fieldsPath = (path ? path + "." : "") + field + "." + key;
                                                    for (var _i = 0, _a = this.keyValidators; _i < _a.length; _i++) {
                                                        let keyValidator = _a[_i];
...
/***/ function (module, exports, __nested_webpack_require_1897__) {
                                ...
                                var Router = (function () {
                                    ...
                                    Router.prototype.registerHandler = function (routeRecognizer, method, url, handler) {
                                        let routeRecognizerHandler = function (request) {
                                        ...
                                        let internalHandler = {
                                            test: function (request) {
                                                ...
                                                let matchingRoutes = routeRecognizer.recognize(request.url);
...
/***/ function (module, exports, __nested_webpack_require_6218__) {
                                ...
                                var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK let INJECTION */(function (module) {
                                    (function () {
                                        "use strict";
                                        ...
                                        $$route$recognizer$dsl$$Matcher.prototype = {
                                            ...
                                            addChild: function (path, target, callback, delegate) {
                                                let matcher = new $$route$recognizer$dsl$$Matcher(target);
                                                this.children[path] = matcher;

                                                let match = $$route$recognizer$dsl$$generateMatch(path, matcher, delegate);
                                        ...
                                        let $$route$recognizer$dsl$$default = function (callback, addRouteCallback) {
                                            let matcher = new $$route$recognizer$dsl$$Matcher();
                                        ...
                                        let $$route$recognizer$$specials = [
                                            '/', '.', '*', '+', '?', '|',
                                            '(', ')', '[', ']', '{', '}', '\\'
                                        ];

                                        let $$route$recognizer$$escapeRegex = new RegExp('(\\' + $$route$recognizer$$specials.join('|\\') + ')', 'g');
                                        ...
                                        let $$route$recognizer$$oCreate = Object.create || function (proto) {
                                            function F() { }
                                            F.prototype = proto;
                                            return new F();
                                        };
                                        ...
                                        function $$route$recognizer$$findHandler(state, path, queryParams) {
                                            ...
                                            let captures = path.match(regex), currentCapture = 1;
                                            let result = new $$route$recognizer$$RecognizeResults(queryParams);

                                            result.length = handlers.length;

                                            for (var i = 0; i < handlers.length; i++) {
                                                let handler = handlers[i], names = handler.names, params = {};
                                        ...
                                        let $$route$recognizer$$RouteRecognizer = function () {
                                        ...
                                        $$route$recognizer$$RouteRecognizer.prototype = {
                                            add: function (routes, options) {
                                                ...
                                                for (var i = 0; i < routes.length; i++) {
                                                    let route = routes[i], names = [];

                                                    let segments = $$route$recognizer$$parse(route.path, names, specificity);
                                                    ...
                                                    let handler = { handler: route.handler, names: names };
                                                    handlers[i] = handler;
                                                }
                                        ...
                                        let $$route$recognizer$$default = $$route$recognizer$$RouteRecognizer;
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var AdvancedFilterBuilder = /** @class */ (function (_super) {
                        ...
                        AdvancedFilterBuilder.prototype.build = function () {
                            let advancedFilter = new powerbi_models_1.AdvancedFilter(this.target, this.logicalOperator, this.conditions);
                            return advancedFilter;
                        };
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var BasicFilterBuilder = /** @class */ (function (_super) {
                        ...
                        BasicFilterBuilder.prototype.build = function () {
                            let basicFilter = new powerbi_models_1.BasicFilter(this.target, this.operator, this.values);
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var RelativeDateFilterBuilder = /** @class */ (function (_super) {
                        ...
                        RelativeDateFilterBuilder.prototype.build = function () {
                            let relativeDateFilter = new powerbi_models_1.RelativeDateFilter(this.target, this.operator, this.timeUnitsCount, this.timeUnitType, this.isTodayIncluded);
                            return relativeDateFilter;
                        };
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var RelativeTimeFilterBuilder = /** @class */ (function (_super) {
                        ...
                        RelativeTimeFilterBuilder.prototype.build = function () {
                            let relativeTimeFilter = new powerbi_models_1.RelativeTimeFilter(this.target, this.operator, this.timeUnitsCount, this.timeUnitType);
                            return relativeTimeFilter;
                        };
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var TopNFilterBuilder = /** @class */ (function (_super) {
                        ...
                        TopNFilterBuilder.prototype.build = function () {
                            let topNFilter = new powerbi_models_1.TopNFilter(this.target, this.operator, this.itemCount, this.orderByTargetValue);
                            return topNFilter;
                        };
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var BookmarksManager = /** @class */ (function () {
                        ...
                        BookmarksManager.prototype.play = function (playMode) {
                            return __awaiter(this, void 0, void 0, function () {
                                let playBookmarkRequest, response_3;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if ((0, util_1.isRDLEmbed)(this.config.embedUrl)) {
                        ...
                        BookmarksManager.prototype.capture = function (options) {
                            return __awaiter(this, void 0, void 0, function () {
                                let request, response, response_4;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if ((0, util_1.isRDLEmbed)(this.config.embedUrl)) {
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var Create = /** @class */ (function (_super) {
                        ...
                        Create.prototype.getId = function () {
                            let datasetId = (this.createConfig && this.createConfig.datasetId) ? this.createConfig.datasetId : Create.findIdFromEmbedUrl(this.config.embedUrl);
                        ...
                        Create.findIdFromEmbedUrl = function (url) {
                            let datasetIdRegEx = /datasetId="?([^&]+)"?/;
                            let datasetIdMatch = url.match(datasetIdRegEx);
                            let datasetId;
                            if (datasetIdMatch) {
                        ...
                        Create.prototype.create = function () {
                            let _a;
                            return __awaiter(this, void 0, void 0, function () {
                                let errors, headers, response, response_1;
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var Dashboard = /** @class */ (function (_super) {
                        ...
                        function Dashboard(service, element, config, phasedRender, isBootstrap) {
                            let _this = _super.call(this, service, element, config, /* iframe */ undefined, phasedRender, isBootstrap) || this;
                        ...
                        Dashboard.findIdFromEmbedUrl = function (url) {
                            let dashboardIdRegEx = /dashboardId="?([^&]+)"?/;
                            let dashboardIdMatch = url.match(dashboardIdRegEx);
                            let dashboardId;
                            if (dashboardIdMatch) {
                        ...
                        Dashboard.prototype.getId = function () {
                            let config = this.config;
                            let dashboardId = config.id || this.element.getAttribute(Dashboard.dashboardIdAttribute) || Dashboard.findIdFromEmbedUrl(config.embedUrl);
                        ...
                        Dashboard.prototype.validate = function (baseConfig) {
                            ...
                            let error = (0, powerbi_models_1.validateDashboardLoad)(config);
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var Embed = /** @class */ (function () {
                        ...
                        Embed.prototype.load = function (phasedRender) {
                            let _a;
                            return __awaiter(this, void 0, void 0, function () {
                                let path, headers, timeNow, response, response_4;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                        ...
                        Embed.prototype.off = function (eventName, handler) {
                            let _this = this;
                            let fakeEvent = { name: eventName, type: null, id: null, value: null };
                            if (handler) {
                                ...
                                let eventHandlersToRemove = this.eventHandlers
                        ...
                        Embed.prototype.setAccessToken = function (accessToken) {
                            return __awaiter(this, void 0, void 0, function () {
                                let embedType, response, response_5;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!accessToken) {
                        ...
                        Embed.prototype.getAccessToken = function (globalAccessToken) {
                            let accessToken = this.config.accessToken || this.element.getAttribute(Embed.accessTokenAttribute) || globalAccessToken;
                            if (!accessToken) {
                        ...
                        Embed.prototype.populateConfig = function (config, isBootstrap) {
                            ...
                            let extensions = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.settings) === null || _b === void 0 ? void 0 : _b.extensions;
                            ...
                            let extensionsArray = (_j = (_h = this.config) === null || _h === void 0 ? void 0 : _h.settings) === null || _j === void 0 ? void 0 : _j.extensions;
                        ...
                        Embed.prototype.validateEventHooks = function (eventHooks) {
                            ...
                            let applicationContextProvider = eventHooks.applicationContextProvider;
                            ...
                            let accessTokenProvider = eventHooks.accessTokenProvider;
                        ...
                        Embed.prototype.fullscreen = function () {
                            let requestFullScreen = this.iframe.requestFullscreen || this.iframe.msRequestFullscreen || this.iframe.mozRequestFullScreen || this.iframe.webkitRequestFullscreen;
                        ...
                        Embed.prototype.isFullscreen = function (iframe) {
                            let options = ['fullscreenElement', 'webkitFullscreenElement', 'mozFullscreenScreenElement', 'msFullscreenElement'];
                        ...
                        Embed.prototype.setIframe = function (isLoad, phasedRender, isBootstrap) {
                            ...
                            if (!this.iframe) {
                                ...
                                let embedUrl = this.config.uniqueId ? (0, util_1.addParamToUrl)(this.config.embedUrl, 'uid', this.config.uniqueId) : this.config.embedUrl;
                            ...
                            if (isLoad) {
                                if (!isBootstrap) {
                                    ...
                                    let errors = this.validate(this.config);
                                    if (errors) {
                                        throw errors;
                                    }
                                }
                        ...
                        Embed.findGroupIdFromEmbedUrl = function (url) {
                            let groupIdRegEx = /groupId="?([^&]+)"?/;
                            let groupIdMatch = url.match(groupIdRegEx);
                            let groupId;
                            if (groupIdMatch) {
                        ...
                        Embed.prototype.frontLoadSendConfig = function (config) {
                            return __awaiter(this, void 0, void 0, function () {
                                let errors, response, response_6;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var Page = /** @class */ (function () {
                        ...
                        Page.prototype.updateFilters = function (operation, filters) {
                            return __awaiter(this, void 0, void 0, function () {
                                let updateFiltersRequest, response_2;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                        ...
                        Page.prototype.getVisualByName = function (visualName) {
                            return __awaiter(this, void 0, void 0, function () {
                                let response, visual, response_8;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if ((0, util_1.isRDLEmbed)(this.report.config.embedUrl)) {
                        ...
                        Page.prototype.hasLayout = function (layoutType) {
                            return __awaiter(this, void 0, void 0, function () {
                                let layoutTypeEnum, response, response_10;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if ((0, util_1.isRDLEmbed)(this.report.config.embedUrl)) {
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var Report = /** @class */ (function (_super) {
                        ...
                        Report.findIdFromEmbedUrl = function (url) {
                            let reportIdRegEx = /reportId="?([^&]+)"?/;
                            let reportIdMatch = url.match(reportIdRegEx);
                            let reportId;
                            if (reportIdMatch) {
                         ...
                         * ```javascript
                         * // Load report
                         * let report = powerbi.load(element, config);
                         *
                         * ...
                         *
                         * // Render report
                        ...
                        Report.prototype.addPage = function (displayName) {
                            return __awaiter(this, void 0, void 0, function () {
                                let request, response, page, response_2;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            request = {
                        ...
                        Report.prototype.updateFilters = function (operation, filters) {
                            return __awaiter(this, void 0, void 0, function () {
                                let updateFiltersRequest, response_6;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            updateFiltersRequest = {
                        ...
                        Report.prototype.getId = function () {
                            let config = this.config;
                            let reportId = config.id || this.element.getAttribute(Report.reportIdAttribute) || Report.findIdFromEmbedUrl(config.embedUrl);
                        ...
                        Report.prototype.getActivePage = function () {
                            return __awaiter(this, void 0, void 0, function () {
                                let response, activePage, response_10;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if ((0, util_1.isRDLEmbed)(this.config.embedUrl)) {
                        ...
                        Report.prototype.updateSettings = function (settings) {
                            let _a, _b;
                            return __awaiter(this, void 0, void 0, function () {
                                let response, extension, extensionsArray, response_13;
                                let _this = this;
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                        ...
                        Report.prototype.switchMode = function (viewMode) {
                            return __awaiter(this, void 0, void 0, function () {
                                let newMode, url, response, response_14;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                        ...
                        Report.prototype.removeContextMenuCommand = function (commandName, contextMenuTitle) {
                            return __awaiter(this, void 0, void 0, function () {
                                let commandCopy, indexOfCommand, newSetting;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if ((0, util_1.isRDLEmbed)(this.config.embedUrl)) {
                        ...
                        Report.prototype.switchLayout = function (layoutType) {
                            return __awaiter(this, void 0, void 0, function () {
                                let isInitialMobileSettings, isPassedMobileSettings, newSetting, response;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                        ...
                        Report.prototype.createMenuCommand = function (type, commandName, commandTitle, menuTitle, menuLocation, visualName, visualType, groupName, icon) {
                            ...
                            if (groupName) {
                                let extend = newCommandObj.extend[type];
                                delete extend.menuLocation;
                                let groupExtend = newCommandObj.extend[type];
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var Service = /** @class */ (function () {
                        ...
                        Service.prototype.createReport = function (element, config) {
                            ...
                            let component = new create_1.Create(this, powerBiElement, config);
                        ...
                        Service.prototype.quickCreate = function (element, config) {
                            ...
                            let powerBiElement = element;
                            let component = new quickCreate_1.QuickCreate(this, powerBiElement, config);
                            powerBiElement.powerBiEmbed = component;
                            this.addOrOverwriteEmbed(component, element);
                            return component;
                        };
                        ...
                        Service.prototype.init = function (container, config) {
                            ...
                            let elements = Array.prototype.slice.call(container.querySelectorAll("[".concat(embed_1.Embed.embedUrlAttribute, "]")));
                        ...
                        Service.prototype.embedNew = function (element, config, phasedRender, isBootstrap) {
                            let componentType = config.type || element.getAttribute(embed_1.Embed.typeAttribute);
                            if (!componentType) {
                                let scrubbedConfig = __assign(__assign({}, config), { accessToken: "" });
                            ...
                            let component = this.createEmbedComponent(componentType, element, config, phasedRender, isBootstrap);
                        ...
                        Service.prototype.createEmbedComponent = function (componentType, element, config, phasedRender, isBootstrap) {
                            let Component = utils.find(function (embedComponent) { return componentType === embedComponent.type.toLowerCase(); }, Service.components);
                            if (Component) {
                            ...
                            let registeredComponent = utils.find(function (registeredComponentType) { return componentType.toLowerCase() === registeredComponentType.toLowerCase(); }, Object.keys(this.registeredComponents));
                        ...
                        Service.prototype.embedExisting = function (element, config, phasedRender) {
                            let component = utils.find(function (x) { return x.element === element; }, this.embeds);
                            if (!component) {
                                let scrubbedConfig = __assign(__assign({}, config), { accessToken: "" });
                            ...
                            if (typeof config.type === "string" && config.type !== component.config.type) {
                                ...
                                if (config.type === "report" && utils.isCreate(component.config.type)) {
                                    let report = new report_1.Report(this, element, config, /* phasedRender */ false, /* isBootstrap */ false, element.powerBiEmbed.iframe);
                        ...
                        Service.prototype.handleEvent = function (event) {
                            let embed = utils.find(function (embed) {
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var Tile = /** @class */ (function (_super) {
                        ...
                        Tile.prototype.getId = function () {
                            let config = this.config;
                            let tileId = config.id || Tile.findIdFromEmbedUrl(this.config.embedUrl);
                        ...
                        Tile.findIdFromEmbedUrl = function (url) {
                            let tileIdRegEx = /tileId="?([^&]+)"?/;
                            let tileIdMatch = url.match(tileIdRegEx);
                            let tileId;
                            if (tileIdMatch) {
...
/***/ (function (__unused_webpack_module, exports) {
                    ...
                    function find(predicate, xs) {
                        let index = findIndex(predicate, xs);
                        return xs[index];
                    }
                    exports.find = find;
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var Visual = /** @class */ (function (_super) {
                        ...
                        Visual.prototype.getVisualDescriptor = function () {
                            return __awaiter(this, void 0, void 0, function () {
                                let config, response, embeddedVisuals, visualNotFoundError, embeddedVisual, currentPage, response_1;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            config = this.config;
                        ...
                        Visual.prototype.updateFilters = function (operation, filters, filtersLevel) {
                            return __awaiter(this, void 0, void 0, function () {
                                let updateFiltersRequest, url, response_3;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            updateFiltersRequest = {
...
/***/ (function (__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    var VisualDescriptor = /** @class */ (function () {
                        ...
                        VisualDescriptor.prototype.exportData = function (exportDataType, rows) {
                            return __awaiter(this, void 0, void 0, function () {
                                let exportDataRequestBody, response, response_4;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                        ...
                        VisualDescriptor.prototype.moveVisual = function (x, y, z) {
                            return __awaiter(this, void 0, void 0, function () {
                                let pageName, visualName, report;
                                return __generator(this, function (_a) {
