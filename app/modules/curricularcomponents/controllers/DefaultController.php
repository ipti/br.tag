...
class DefaultController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $baseDisciplines = EdcensoBaseDisciplines::model()->findAll();
        ...
        $this->render('create', array(
            'model'=>$model,
            'edcenso_base_disciplines' => $baseDisciplines,
        ));
    }
    ...
    public function actionUpdate($id)
    {
        ...
        if(isset($_POST['EdcensoDiscipline'])) {
            ...
            if($model->save()) {
                $this->redirect(array('index'));
                return; // Termina a execução após o redirecionamento
            }
        }
    ...
    public function actionDelete($id)
    {
        ...
        if($curricularComponent->edcenso_base_discipline_fk < 99) {
            $errorMsg = Yii::t('default', 'Não é possível remover um componente base do EducaCenso');
        ...
        if ($curricularComponent->delete()) {
            ...
            return; // Retorno antecipado em caso de sucesso
        }
