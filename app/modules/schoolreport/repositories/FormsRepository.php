...
class FormsRepository
{
    ...
    public function getStudnetIMC($classroomid)
    {
        ...
        foreach ($enrollments as $enrollment) {
            ...
            Yii::import('application.modules.student.models.StudentIMC');
            Yii::import('application.modules.student.models.StudentImcClassification');
    ...
    {
        Yii::import('application.modules.student.models.StudentIMC');
        Yii::import('application.modules.student.models.StudentDisorderHistory');
        Yii::import('application.modules.student.models.StudentImcClassification');
