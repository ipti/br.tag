        ...
        <div id="report">
            ...
            <div style="margin: 0 0 0 50px; width: calc(100% - 51px); text-align:center">
                <div style="float: left; text-align: justify;margin: 5px 0 20px -20px;line-height: 14px;">
                    ...
                    <div class="span6">
                        <b>NATURALIDADE:
                        </b><?= strtoupper($enrollment->studentFk->edcensoCityFk->name) . "/" . $enrollment->studentFk->edcensoUfFk->acronym ?>
                    </div>
                    <div class="span6">
                    ...
                    <div class="span6">
                        <b>ÓRGÃO EXPEDIDOR:
                        </b><?= $enrollment->studentFk->documentsFk->rgNumberEdcensoOrganIdEmitterFk->name ?>
                    </div>
                    ...
                    <div class="span6"><b>ETAPA: </b><?= strtoupper($enrollment->edcensoStageVsModalityFk->name) ?>
                    </div>
            ...
            <table style="margin: 20px 0 0 25px; font-size: 10px; width: calc(100% - 51px);"
                    ...
                    <tr>
                        ...
                        <?php if (count($baseDisciplines) > 0) { ?>
                            <td colspan="<?= count($baseDisciplines) ?>"
                                style="text-align: center; font-weight: bold; min-width:150px;">
                                <?= $isMinorEducation ? "Eixos/Componentes" : "BASE NACIONAL COMUM" ?></td>
                        <?php } ?>
                        <?php if (count($diversifiedDisciplines) > 0) { ?>
                            <td colspan="<?= count($diversifiedDisciplines) ?>"
                                style="text-align: center; font-weight: bold; min-width:100px;">
                                PARTE DIVERSIFICADA
                            </td>
                        <?php } ?>
                        ...
                        <tr>
                            ...
                            for ($j = 0; $j < $diciplinesColumnsCount; $j++) {
                                ...
                                <?php } elseif ($unities[$i - 1]->type == 'FC') {
                                    ...
                                    ?>
                                    <td style="text-align: center;"><?= $finalConcept->acronym ?></td>
                                <?php } elseif ($unities[$i - 1]->type == 'UC') { ?>
                                    <td style="text-align: center;"><?= $gradeResult['grade_concept_' . $i] ?></td>
                                    <?php
                                } elseif (
                                    $gradeResult['grade_' . $i] < $gradeResult['rec_partial_' . $i] &&
                            ...
                            <?php if ($unities[$i - 1]->type != 'RF') { ?>
                                ...
                                <td style="text-align: center;">
                                    <?= $gradeResultFaults == 0 ? $faults[$i - 1] : $gradeResultFaults ?></td>
                            <?php } else { ?>
                ...
                <tr>
                    ...
                    <?php if ($isMinorEducation): ?>
                        <td style="text-align:right;" colspan="<?= $diciplinesColumnsCount ?>">
                            <?= $result[0]['total_number_of_classes'] ?></td>
                    <?php else: ?>
                        <?php for ($i = 0; $i < $diciplinesColumnsCount; $i++): ?>
                ...
                <tr>
                    ...
                    <?php if ($isMinorEducation): ?>
                        <td style="text-align: right;" colspan="<?= $diciplinesColumnsCount ?>">
                            <?= $result[0]['frequency_percentage'] . "%" ?></td>
                    <?php else: ?>
                        <?php for ($i = 0; $i < $diciplinesColumnsCount; $i++): ?>
                            <td style="text-align: center;">
                                <?= is_nan($result[$i]['frequency_percentage'] ?? NAN) || $result[$i]['frequency_percentage'] < 0 ? "" : ceil($result[$i]['frequency_percentage']) . "%" ?>
                            </td>
                        <?php endfor; ?>
                    <?php endif; ?>
                    <td></td>
            ...
            <div class="local-and-date pull-right" style="margin: 30px 25px 50px 0">
                <span class="written-date"
                    style=""><?= $enrollment->classroomFk->schoolInepFk->edcensoCityFk->name ?>/<?= $enrollment->classroomFk->schoolInepFk->edcensoUfFk->acronym ?>,
                    <?php echo date('d') . " de " . yii::t('default', date('F')) . " de " . date('Y') . "." ?></span>
                <span class="line-date"
                    style="display:none">__________________________,______________________________________________<p
                        style="text-align: center;">Local e Data</p></span>
            </div>
            <div>
                <table style="width: 100%;text-align: center">
                    ...
                    <tbody>
                        <tr>
                            <td><span>_________________________________________________________</span><br><span>Assinatura
                                    do(a) Secretário(a)</span></td>
                            <td><span>_________________________________________________________</span><br><span>Assinatura
                                    do(a) Diretor(a)</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
