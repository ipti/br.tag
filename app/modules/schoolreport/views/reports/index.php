...
<div class="main">
    ...
    <div class="home">
        <div class="row-fluid">
            ...
            <div class="container-box student-report-container">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/NumberStudentsPerClassroomReport') ?>" target="_blank" rel="noopener">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/EnrollmentStatisticsByYearReport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/incompatiblestudentagebyclassroomreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/studentpendingdocument') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/studentsbyclassroomreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/studentsbetween5and14yearsoldreport', array('id' => Yii::app()->user->school)) ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/studentsinalphabeticalorderrelationreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/studentspecialfood') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/outoftownstudentsreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/electronicdiary') ?>" target="_blank" rel="noopener">
            ...
            <div class="container-box">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/schoolprofessionalnumberbyclassroomreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/TeachersByStage') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/disciplineandinstructorrelationreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/InstructorsPerClassroomReport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/classroomwithoutinstructorrelationreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
            ...
            <div class="container-box">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/studentsusingschooltransportationrelationreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/SchoolTransferReport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/educationalassistantperclassroomreport', array('id' => Yii::app()->user->school)) ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/enrollmentcomparativeanalysisreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/studentswithdisabilitiesrelationreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                            <span class="t-icon-wheelchair t-reports_icons"></span>
                        </div>
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/complementaractivityassistantbyclassroomreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/studentinstructornumbersrelationreport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/CnsPerSchool') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/StudentCpfRgNisAllClassrooms') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                            <span class="t-id-card-clip t-reports_icons"></span>
                        </div>
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/AllClassroomsReportOfStudentsBenefitingFromTheBF') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                            <span class="t-group-bag t-reports_icons"></span>
                        </div>
            ...
            <div class="container-box">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/AllSchoolsTransferReport') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/TeachersBySchool') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/StudentsWithDisabilitiesPerSchool') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                            <span class="t-icon-wheelchair t-reports_icons"></span>
                        </div>
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/StatisticalData') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/AllSchoolsReportOfStudentsBenefitingFromTheBF') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/NumberOfClassesPerSchool') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
                ...
                <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/TotalNumberOfStudentsEnrolled') ?>" target="_blank" rel="noopener">
                    <button type="button" class="report-box-container">
                        <div class="pull-left" style="margin-right: 20px;">
    ...
    <div class="row">
        <div class="modal fade modal-content" id="number-of-students-enrolled-per-period-all-schools" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/NumberOfStudentsEnrolledPerPeriodAllSchools'); ?>" method="post" target="_blank">
    ...
    <div class="row">
        <div class="modal fade modal-content" id="number-of-students-enrolled-per-period-per-school" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/NumberOfStudentsEnrolledPerPeriodPerSchool'); ?>" method="post" target="_blank">
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class=" span12">
                            <div style="display:inline-block;margin-right: 10%;">
    ...
    <div class="row">
        <div class="modal fade modal-content" id="number-of-students-enrolled-per-period-per-classroom" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/ReportOfStudentsBenefitingFromTheBFPerClassroom'); ?>" method="post" target="_blank">
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class=" span12">
                            <?php
    ...
    <div class="row">
        <div class="modal fade modal-content" id="teacher-training" tabindex="-1" role="dialog" style="height: auto !important;">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/TeacherTrainingReport'); ?>" method="post" target="_blank">
    ...
    <div class="row">
        <div class="modal fade modal-content" id="cpf-rg-nis-per-classroom" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/StudentCpfRgNisPerClassroom'); ?>" method="post" target="_blank">
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class=" span12">
                            <?php
    ...
    <div class="row">
        <div class="modal fade modal-content" id="classroom-transfer-report" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/classroomTransferReport'); ?>" method="post" target="_blank">
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class=" span12">
                            <?php
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/StudentCpfRgNisAllSchools') ?>" target="_blank" rel="noopener" style="margin-left: 5px;">
            ...
            <div class="modal-dialog" role="document">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                            <a href="<?php echo Yii::app()->createUrl('schoolreport/reports/CnsSchools') ?>" target="_blank" rel="noopener" style="margin-left: 5px;">
                                <button type="button" class="btn btn-primary">Gerar</button>
                            </a>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="modal fade modal-content" id="reportFamilyBag" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/BFReport'); ?>" method="post" target="_blank">
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class=" span12">
                            <?php
    ...
    <div class="row">
        <div class="modal fade modal-content" id="studentswithdisabilitiesperclassroom" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/studentswithdisabilitiesperclassroom'); ?>" method="post" target="_blank">
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class=" span12">
                            <?php
    ...
    <div class="row">
        <div class="modal fade modal-content" id="studentperclassroom" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/StudentByClassroomReport'); ?>" method="post" target="_blank">
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class=" span12">
                            <?php
    ...
    <div class="row">
        <div class="modal fade modal-content" id="cns-per-classroom" tabindex="-1" role="dialog">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/CnsPerClassroomReport'); ?>" method="post" target="_blank">
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class=" span12">
                            <?php
    ...
    <div class="row">
        <div class="modal fade modal-content" id="quarterly-class-council" tabindex="-1" role="dialog" style="height: auto !important;">
            ...
            <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/ClassCouncilReport'); ?>" method="post" target="_blank">
                <div class="modal-body" style="max-height: none !important;overflow: visible !important;">
                    <div class="row-fluid">
                        <div class=" span12">
                            <?php
...
<div class="row">
    <div class="modal fade modal-content" id="quarterly-report" tabindex="-1" role="dialog">
        ...
        <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/QuarterlyReport'); ?>" method="post" target="_blank">
            <div class="modal-body">
                <div class="row-fluid">
                    <div class=" span12">
                        <?php
...
<div class="row">
    <div class="modal fade modal-content" id="quarterly-follow-up" tabindex="-1" role="dialog">
        ...
        <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/QuarterlyFollowUpReport'); ?>" method="post" target="_blank">
            <div class="modal-body">
                <div class="row-fluid">
                    <div class=" span12">
                        <?php
...
<div class="row">
    <div class="modal fade modal-content" id="evaluation-follow-up-students" tabindex="-1" role="dialog">
        ...
        <form class="form-vertical" action="<?php echo Yii::app()->createUrl('schoolreport/reports/EvaluationFollowUpStudentsReport'); ?>" method="post" target="_blank">
            <div class="modal-body">
                <div class="row-fluid">
                    <div class=" span12">
                        <?php
