                        ...
                        <?php foreach ($users as $user) {?>
                            <tr>
                                <td class="link-update-grid-view" tabindex="0">
                                    <a href="/?r=systemadmin/default/update&id=<?=$user->id?>" style="cursor: pointer;"><?= $user->name?></a>
                                </td>
                                <td><?= $user->username?></td>
                                <td style="text-align:center;">
                                    <a href="/?r=systemadmin/default/<?php echo $user->active ? "disable" : "active"?>User&id=<?=$user->id?>" style="cursor: pointer;">
