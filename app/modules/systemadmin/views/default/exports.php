            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="container-box">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('systemadmin/default/exportMaster') ?>">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('systemadmin/default/exportStudents') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                                    <span class="t-icon-submit-form t-reports_icons"></span>
                                </div>
                        ...
                        <a href="<?php echo Yii::app()->createUrl('systemadmin/default/exportGrades') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                                    <span class="t-icon-submit-form t-reports_icons"></span>
                                </div>
                        ...
                        <a href="<?php echo Yii::app()->createUrl('systemadmin/default/exportFaults') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                                    <span class="t-icon-submit-form t-reports_icons"></span>
                                </div>
