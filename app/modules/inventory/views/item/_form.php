...
<?php $form = $this->beginWidget('CActiveForm', [
	...
	<div class="row">
        <div class="column is-one-half t-field-text clearfix">
            ...
            <?php echo $form->textField($model, 'name', ['size' => 60, 'maxlength' => 255, 'class' => 't-field-text__input']); ?>
	...
	<div class="row">
        <div class="column is-one-fourth t-field-text clearfix">
            ...
            <?php echo $form->textField($model, 'unit', ['size' => 50, 'maxlength' => 50, 'class' => 't-field-text__input']); ?>
            <?php echo $form->error($model, 'unit'); ?>
        </div>
        <div class="column is-one-fourth t-field-text clearfix">
            <?php echo $form->labelEx($model, 'minimum_stock', ['class' => 't-field-text__label']); ?>
            <?php echo $form->numberField($model, 'minimum_stock', ['size' => 10, 'class' => 't-field-text__input', 'step' => 'any', 'min' => '0']); ?>
	...
	<div class="row">
        <div class="column is-one-half t-field-text clearfix">
            ...
            <?php echo $form->textArea($model, 'description', ['rows' => 6, 'cols' => 50, 'class' => 't-field-text__input']); ?>
