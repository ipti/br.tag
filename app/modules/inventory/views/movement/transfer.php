...
echo $form->dropDownList($model, 'item_id', CHtml::listData(InventoryItem::model()->findAll($itemCriteria), 'id', 'name'), ['prompt' => 'Selecione o Item no Central', 'class' => 't-field-select__input select2-container']);
?>
            ...
            <div class="column is-one-third t-field-select clearfix">
                ...
                <?php echo $form->dropDownList($model, 'school_inep_fk', CHtml::listData(SchoolIdentification::model()->findAll(['condition' => 'situation=1']), 'inep_id', 'name'), ['prompt' => 'Selecione a Escola', 'class' => 't-field-select__input select2-container']); ?>
