    ...
    <?php $form = $this->beginWidget('CActiveForm', [
        ...
        <div class="row">
            <div class="column is-one-third t-field-select clearfix">
                ...
                <?php echo $form->dropDownList($model, 'item_id', CHtml::listData(InventoryItem::model()->findAll(), 'id', 'name'), ['prompt' => 'Selecione o Item', 'class' => 't-field-select__input select2-container']); ?>
...
echo $form->dropDownList($model, 'school_inep_fk', $schools, ['prompt' => 'Selecione o Destino', 'class' => 't-field-select__input select2-container']);
?>
        ...
        <div class="row">
            ...
            <div class="column is-one-third t-field-text clearfix">
                ...
                <?php echo $form->textField($model, 'destination', ['size' => 60, 'maxlength' => 255, 'class' => 't-field-text__input', 'placeholder' => 'Ex: Fornecedor X, Doação']); ?>
