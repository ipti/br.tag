...
echo $form->dropDownList($model, 'item_id', CHtml::listData(InventoryItem::model()->findAll($itemCriteria), 'id', 'name'), ['prompt' => 'Selecione o Item', 'class' => 't-field-select__input select2-container']); ?>
...
$schools = CHtml::listData(SchoolIdentification::model()->findAll(['condition' => 'situation=1']), 'inep_id', 'name');
                ...
                echo $form->dropDownList($model, 'school_inep_fk', $schools, ['prompt' => 'Selecione a Escola', 'class' => 't-field-select__input select2-container']);
                ?>
        ...
        <div class="row">
            ...
            <div class="column is-one-third t-field-text clearfix">
                ...
                <?php echo $form->textField($model, 'destination', ['size' => 60, 'maxlength' => 255, 'class' => 't-field-text__input', 'placeholder' => 'Ex: Sala 05, Professor João']); ?>
...
?>
        ...
        <div class="row t-buttons-container">
            ...
            <?php echo CHtml::link('Cancelar', ['index'], ['class' => 't-button-secondary']); ?>
        </div>
