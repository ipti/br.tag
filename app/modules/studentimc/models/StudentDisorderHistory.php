...
class StudentDisorderHistory extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return [
            'studentDisorderFk' => [self::BELONGS_TO, 'StudentDisorder', 'student_disorder_fk'],
            'studentImcFk' => [self::BELONGS_TO, 'StudentImc', 'student_imc_fk'],
        ];
    }
