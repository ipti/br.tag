...
class StudentDisorderHistory extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'student_disorder_fk' => 'Student Disorder Fk',
			'student_imc_fk' => 'Student Imc Fk',
			...
			'disorders_impact_learning' => 'Disorders Impact Learning',
			...
			'hypovitaminosis_a' => 'Hypovitaminosis A',
			'rickets' => 'Rickets',
			'scurvy' => 'Scurvy',
			'iodine_deficiency' => 'Iodine Deficiency',
			'protein_energy_malnutrition' => 'Protein Energy Malnutrition',
			'overweight' => 'Overweight',
			'obesity' => 'Obesity',
			'dyslipidemia' => 'Dyslipidemia',
			'hyperglycemia_prediabetes' => 'Hyperglycemia Prediabetes',
			'type2_diabetes_mellitus' => 'Type2 Diabetes Mellitus',
