...
class StudentAeeRecord extends TagModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['student_fk, school_fk, classroom_fk, instructor_fk', 'required'],
            ['student_fk, classroom_fk, instructor_fk', 'numerical', 'integerOnly' => true],
            ['learning_needs', 'length', 'max' => 1000],
            ['characterization', 'length', 'max' => 3000],
            ['school_fk', 'length', 'max' => 8],
            ['date', 'safe'],
            // The following rule is used by search().
            ['id, date, learning_needs, characterization, student_fk, school_fk, classroom_fk, instructor_fk', 'safe', 'on' => 'search'],
        ];
    }
