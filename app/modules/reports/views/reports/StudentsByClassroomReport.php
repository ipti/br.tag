...
$cs->registerScriptFile($baseScriptUrl . '/js/reports/StudentsByClassroomReport/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);
...
<div class="pageA4H">
    ...
    <h3><?php echo Yii::t('default', 'Students By Classroom') . ' - ' . Yii::app()->user->year; ?></h3>
