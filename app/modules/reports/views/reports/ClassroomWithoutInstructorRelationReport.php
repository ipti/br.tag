...
$cs->registerScriptFile($baseScriptUrl . '/js/reports/ClassroomWithoutInstructorRelationReport/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);
...
<div class="pageA4H">
    ...
    <h3><?php echo Yii::t('default', 'Classroom Without Instructor Relation') . ' - ' . Yii::app()->user->year; ?></h3>
