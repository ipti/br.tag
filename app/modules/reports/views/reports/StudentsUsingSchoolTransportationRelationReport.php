...
$cs->registerScriptFile($baseScriptUrl . '/js/reports/StudentsUsingSchoolTransportationRelationReport/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);
...
?>
    ...
    <h3><?php echo Yii::t('default', 'Students Using School Transportation Relation') . ' - ' . Yii::app()->user->year;?></h3>
