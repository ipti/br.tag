...
$cs->registerScriptFile($baseScriptUrl . '/js/reports/BFReport/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);

$this->setPageTitle('TAG - ' . Yii::t('default', 'Reports'));
?>
<div class="pageA4H" style="width: 1080px;">
    <?php $this->renderPartial('HeadWithoutSchool'); ?>
    <h3><?php echo Yii::t('default', 'TOTAL DE ALUNOS MATRICULADOS POR ESCOLA') . ' - ' . Yii::app()->user->year; ?></h3>
