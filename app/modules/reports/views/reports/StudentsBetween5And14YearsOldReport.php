...
$cs->registerScriptFile($baseScriptUrl . '/js/reports/StudentsBetween5And14YearsOldReport/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);
$this->setPageTitle('TAG - ' . Yii::t('default', 'Reports'));

?>
<div class="pageA4H">
    <?php $this->renderPartial('head'); ?>
    <h3><?php echo Yii::t('default', 'Students Between 5 And 14 Years Old') . ' - ' . Yii::app()->user->year; ?></h3>
