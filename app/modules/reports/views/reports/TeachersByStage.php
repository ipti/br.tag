...
$cs->registerScriptFile($baseScriptUrl . '/js/reports/TeachersByStage/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);
...
<div class="pageA4H">
    ...
    <h3><?php echo Yii::t('default', 'Teachers By Stage') . ' - ' . Yii::app()->user->year; ?></h3>
