<?php
    ...
    $cs->registerScriptFile($baseScriptUrl . '/js/reports/StudentsWithDisabilitiesPerSchool/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);
    $this->setPageTitle('TAG - ' . Yii::t('default', 'Reports'));
?>
<div class="pageA4H">
    <?php $this->renderPartial('head'); ?>
    <h3><?php echo Yii::t('default', 'Students With Disabilities Per School Relation') . ' - ' . Yii::app()->user->year; ?></h3>
