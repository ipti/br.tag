    ...
    public function actionGetDisciplines()
    {
        ...
        if (Yii::app()->getAuthManager()->checkAccess('instructor', Yii::app()->user->loginInfos->id)) {
            ...
            foreach ($disciplines as $discipline) {
                $result[] = ['id' => $discipline['id'], 'name' => CHtml::encode($disciplinesLabels[$discipline['id']]), 'isMinorEducation' => $isMinorEducation];
            }
            ...
            foreach ($disciplines as $i => $discipline) {
                if (isset($discipline['discipline_fk'])) {
                    $result[] = ['id' => $discipline['discipline_fk'], 'name' => CHtml::encode($disciplinesLabels[$discipline['discipline_fk']]), 'isMinorEducation' => $isMinorEducation];
                }
            }
