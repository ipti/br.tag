...
/**
 * This is the model class for table "lunch_meal".
 *
 * The followings are the available columns in table 'lunch_meal':
 * @property integer $id
...
class Meal extends TagModel
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            ['restrictions', 'length', 'min' => 5, 'max' => 1000],
