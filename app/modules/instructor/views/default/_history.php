...
<div style="padding: 20px 12px;">
    ...
    <div style="display:flex; align-items:center; gap:10px; margin-bottom:18px;">
        ...
        <a href="<?= Yii::app()->createUrl('instructor/default/printHistory', ['id' => $instructor->id]) ?>"
           target="_blank"
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="
                    ...
                    text-align:center;
                ">
                    <a href="<?= Yii::app()->createUrl('instructor/default/printYearHistory', ['id' => $instructor->id, 'year' => $year]) ?>"
                       target="_blank"
            ...
            <tr style="<?= $i % 2 === 0 ? 'background:#fff;' : 'background:#fafafe;' ?> color:#252A31;">
                ...
                <td style="padding:6px 10px; border-bottom:1px solid #eff2f5; text-align:center;">
                    <a href="<?= Yii::app()->createUrl('instructor/default/printHistory', ['id' => $instructor->id, 'teaching_id' => $row['id']]) ?>"
                       target="_blank"
