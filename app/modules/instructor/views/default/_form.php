                        ...
                        <div class=" span6">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <label class="checkbox">
                                        <?php
                                        echo InstructorVariableData::model()->attributeLabels()['other_courses_full_time_education'];
                                        echo $form->checkBox(
                                            $modelInstructorVariableData,
                                            'other_courses_full_time_education',
                                            array(
                                                'class' => 'other_courses',
                                                'value' => 1,
                                                'uncheckValue' => 0
                                                            ...
                                                            <div class="controls">
                                                                <?php echo CHtml::DropDownList(
                                                                    ...
                                                                    array(
                                                                        ...
                                                                        'ajax' => array(
                                                                            'type' => 'POST',
                                                                            'url' => Yii::app()->createUrl('instructor/getCourses&tdid=2'),
                                                                            'success' => "function(data){
