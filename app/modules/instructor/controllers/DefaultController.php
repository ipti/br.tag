                ...
                if ($modelInstructorIdentification->validate() &&
                    ...
                    if ($modelInstructorIdentification->save()) {
                        ...
                        if ($modelInstructorDocumentsAndAddress->save() && $modelInstructorVariableData->save()) {
                            ...
                            $this->redirect(['instructor/default/index']);
                        }
                    }
                }
            }
...
preenchidos';
        ...
        if ($numClassrooms > 0) {
            ...
            foreach ($classrooms as $classroom) {
                $teachingData =
                    ...
                    '<br>';
                $anchorToUpdateClassroom = "<a href='" . Yii::app()->createUrl('classroom/default/update', ['id' => $classroom['cid']]) . "'>" . $teachingData . '</a>';
    ...
    public function actionAdmin()
    {
        ...
        $modelInstructorIdentification->unsetAttributes();
        $modelInstructorDocumentsAndAddress->unsetAttributes();
        $modelInstructorVariableData->unsetAttributes();
        $modelInstructorTeachingData->unsetAttributes();
    ...
    /**
     * Renders a printable consolidated ficha for a given instructor in a specific year.
     * @param int $id Instructor ID
