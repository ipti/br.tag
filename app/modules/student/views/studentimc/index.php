        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="t-buttons-container">
                    <a class="t-button-primary" href="<?= Yii::app()->createUrl('student/studentimc/create', ['studentId' => $student->id]) ?>">
                        Nova Coleta
                    </a>
                     <a class="t-button-secondary" href="<?php echo Yii::app()->createUrl('schoolreport/forms/studentIMCHistoryReport', ['studentId' => $student->id]) ?>">Histórico de coleta</a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                $this->widget('zii.widgets.grid.CGridView', [
                    ...
                    'columns' => [
                        ...
                        [
                            'name' => 'IMC',
                            'type' => 'raw',
                            'value' => 'CHtml::link(number_format((float) $data->IMC, 2, ".", ""),Yii::app()->createUrl("student/studentimc/update",array("id"=>$data->id)))',
