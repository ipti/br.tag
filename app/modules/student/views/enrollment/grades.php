...
$cs->registerScriptFile($baseScriptUrl . '/js/enrollment/grades/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseScriptUrl . '/js/enrollment/grades/functions.js?v='.TAG_VERSION, CClientScript::POS_END);
