<div id="mainPage" class="main">
    ...
    <div class="span12">
        ...
        <div class="buttons">
                <a href="?r=student/enrollment/create" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i> Nova matrícula</a>
        </div>
    </div>
</div>
                ...
                $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                                'name' => 'student_fk',
                                'type' => 'raw',
                                'value' => 'CHtml::link($data->studentFk->name,Yii::app()->createUrl("/student/enrollment/update",array("id"=>$data->id)))',
                                
                            ),
                        array(
                                'name' => 'classroom_fk',
                                'type' => 'raw',
                                'value' => 'CHtml::link($data->classroomFk->name,Yii::app()->createUrl("/student/enrollment/update",array("id"=>$data->id)))',
                                'htmlOptions' => array('width'=>'150px')
                        ),
