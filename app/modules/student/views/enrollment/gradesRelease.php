...
$cs->registerScriptFile($baseScriptUrl . '/js/enrollment/gradesRelease/_initialization.js?v=' . TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseScriptUrl . '/js/enrollment/gradesRelease/functions.js?v=' . TAG_VERSION, CClientScript::POS_END);
