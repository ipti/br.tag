                    ...
                    <div class="row">
                        <div class="column">
                            ...
                            <div class="t-field-select">
                                ...
                                <?php echo CHtml::dropDownList("Stage", $model->edcensoStageVsModalityFk->stage, array(
                            ...
                            <?php if (Yii::app()->features->isEnable(TFeature::FEAT_INTEGRATIONS_SEDSP)): ?>
                                <div class="t-field-select" id="reasonDropdown" style="display: none;">
                                    ...
                                    <select name="reason" id="reason" class="select-search-off t-field-select__input"
                                        style="width:100%">
                                ...
                                <div id="secondDropdown" style="display: none;">
                                    ...
                                    <select name="secondReason" id="secondReason"
                                        class="select-search-off t-field-select__input" style="width:100%">
                                        <option value="1">Mudança de residência (Exceto para matrículas na educação básica)
                                        </option>
                            ...
                            <div class="t-field-select" style="visibility: hidden;">
                                ...
                                <?php
                                echo $form->DropDownList($model, 'student_entry_form', array(
                        ...
                        <div class="column">
                            ...
                            <div class="control-group hide-responsive" id="transport_type">
                                <label
                                    class="t-field-checkbox__label--required required"><?php echo Yii::t('default', 'Transport Type'); ?>
                                </label>
                                <div class="uniformjs t-field-checkbox-group">
                                    ...
                                    <div class="t-field-checkbox">
                                        ...
                                        <label class="t-field-checkbox__label"
                                            for="StudentEnrollment_vehicle_type_microbus">
                                    ...
                                    <div class="t-field-checkbox">
                                        ...
                                        <label class="t-field-checkbox__label"
                                            for="StudentEnrollment_vehicle_type_bike">
                                    ...
                                    <div class="t-field-checkbox">
                                        ...
                                        <label class="t-field-checkbox__label"
                                            for="StudentEnrollment_vehicle_type_animal_vehicle">
                                    ...
                                    <div class="t-field-checkbox">
                                        ...
                                        <label class="t-field-checkbox__label"
                                            for="StudentEnrollment_vehicle_type_other_vehicle">
                                    ...
                                    <div class="t-field-checkbox">
                                        ...
                                        <label class="t-field-checkbox__label"
                                            for="StudentEnrollment_vehicle_type_waterway_boat_5">
                                    ...
                                    <div class="t-field-checkbox">
                                        ...
                                        <label class="t-field-checkbox__label"
                                            for="StudentEnrollment_vehicle_type_waterway_boat_5_15">
                                    ...
                                    <div class="t-field-checkbox">
                                        ...
                                        <label class="t-field-checkbox__label"
                                            for="StudentEnrollment_vehicle_type_waterway_boat_15_35">
                                    ...
                                    <div class="t-field-checkbox">
                                        ...
                                        <label class="t-field-checkbox__label"
                                            for="StudentEnrollment_vehicle_type_waterway_boat_35">
