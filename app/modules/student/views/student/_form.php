...
echo $form->dropDownList(
    ...
    [
        'ajax' => [
            'type' => 'POST',
            'url' => CController::createUrl('student/student/getcities', ['rt' => 0]),
              ...
              <div class="t-field-select js-hidden-oldDocuments-fields" id="ufRegistry-select">
                ...
                echo $form->dropDownList(
                    ...
                    [
                        'ajax' => [
                            'type' => 'POST',
                            'url' => CController::createUrl('student/student/getcities', ['rt' => 1]),
              ...
              <div class="t-field-select js-hide-not-required">
                ...
                echo $form->dropDownList(
                    ...
                    [
                        'ajax' => [
                            'type' => 'POST',
                            'url' => CController::createUrl('student/student/getcities', ['rt' => 2]),
