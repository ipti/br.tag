            ...
            <div class="t-buttons-container">
                ...
                <div class="mobile-row">
                    ...
                    <a class="t-button-secondary"
                        href="<?= Yii::app()->createUrl('wizard/configuration/student')?>">Matrícula em Grupo</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade modal-content" id="syncStudentToSEDSP" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Sincronizar Aluno para o SEDSP</h4>
        </div>
        <form method="post" action="">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary sync-student-button">Confirmar
                    </button>
                </div>
            </div>
        </form>
...
<style>
    #student-identification-table tbody tr td:nth-child(5),
    #student-identification-table tbody tr td:nth-child(6) {
        text-align: center;
    }
</style>
