...
class GradePartialRecovery extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('partial_recover_media, order_partial_recovery, grade_rules_fk', 'required'),
			array('order_partial_recovery, grade_rules_fk', 'numerical', 'integerOnly'=>true),
			array('partial_recover_media', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, partial_recover_media, order_partial_recovery, grade_rules_fk', 'safe', 'on'=>'search'),
		);
	}
