...
/**
 * This is the model class for table "preenrollment_student_identification".
 *
 * The followings are the available columns in table 'preenrollment_student_identification':
 ...
 */
class OnlineEnrollmentStudentIdentification extends CActiveRecord
{
	/**
	...
	{
		return 'online_enrollment_student_identification';
	}
	...
	public function attributeLabels()
{
    return array(
        ...
        'neighborhood' => 'Bairro',
        'zone' => 'Zona',
        'edcenso_city_fk' => 'Município (EdCenso)',
        'edcenso_uf_fk' => 'UF (EdCenso)',
	 ...
	 * @return PreenrollmentStudentIdentification the static model class
	 */
