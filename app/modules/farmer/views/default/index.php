...
<div id="mainPage" class="main">
    ...
    <div class="row">
        <div class="t-buttons-container">
            <a class="t-button-primary" href="<?php echo Yii::app()->createUrl('farmer/default/create')?>">Adicionar Agricultor</a>
            <a class="t-button-secondary" href="<?php echo Yii::app()->createUrl('farmer/default/activateFarmers')?>">Exibir Inativos</a>
        </div>
    </div>
                ...
                <?php $this->widget('zii.widgets.grid.CGridView', [
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'afterDelete' => 'window.location.href = "?r=farmer/default/index";',
