				...
				<div class="tab-pane active" id="student">
					<div class="row-fluid">	
						<div class=" span5"> 
							<div class="row-fluid">
				                <div class="span3">
				                    <a href="<?php echo Yii::app()->homeUrl; ?>?r=sorcerer/Configuration/school" class="widget-stats">
				                ...
				                <div class="span3">
				                    <a href="<?php echo Yii::app()->homeUrl; ?>?r=sorcerer/Configuration/classroom" class="widget-stats">
				                        <span class="glyphicons flag"><i></i></span>
				                ...
				                <div class="span3">
				                    <a href="<?php echo Yii::app()->homeUrl; ?>?r=sorcerer/Configuration/student" class="widget-stats">
				                        <span class="glyphicons flag"><i></i></span>
