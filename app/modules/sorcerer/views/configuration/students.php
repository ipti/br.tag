					...
					<div class="row-fluid">	
						<div class=" span12">
							<div class="control-group">
								...
								echo chtml::dropDownList('Classrooms', null, 
									CHtml::listData(Classroom::model()->findAllByAttributes(array('school_year'=>$lastYear, 'assistance_type'=>'0'),array('order'=>'edcenso_stage_vs_modality_fk, name ASC')), 'id', 'name', 'edcensoStageVsModalityFk.name'),
									array(
							...
							<div class="control-group">
								...
								echo chtml::dropDownList('Students', "", array(),
									array(
										'class'=>'select-search-on span12',
										'multiple'=>'multiple',
