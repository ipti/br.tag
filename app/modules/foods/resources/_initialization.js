...
if (menuId) {
    ...
    $(".alert")
        ...
        .text("Carregando informações, o processo pode demorar um pouco...")
        .show();
    ...
    menuUpdate.monday.map((e) => {
        ...
        e.mealsComponent.forEach((mealComponent) => {
            let foodIngredients = mealComponent.ingredients.map(
                (foodIngredient) => {
                    let food = {
                        id: idIgredientes,
                        ...
                        amountForUnit:
                            foodIngredient.amountForUnit == null
                                ? ""
                                : foodIngredient.amountForUnit,
                    };
