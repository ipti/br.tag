...
class FoodInventoryReceived extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('food_inventory_fk, food_fk', 'numerical', 'integerOnly'=>true),
            array('amount, previous_amount', 'numerical'),
            array('foodSource', 'length', 'max'=>20),
            array('date, expiration_date', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, amount, foodSource, date, food_inventory_fk, food_fk, expiration_date, previous_amount', 'safe', 'on'=>'search'),
        );
    }
