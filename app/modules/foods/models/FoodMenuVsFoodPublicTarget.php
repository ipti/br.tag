 ...
 * @property int $food_public_target_fk
 *
...
class FoodMenuVsFoodPublicTarget extends TagModel
{
    ...
    public function relations()
    {
        ...
        return [
            'foodMenuFk' => [self::BELONGS_TO, 'FoodMenu', 'food_menu_fk'],
            'foodPublicTargetFk' => [self::BELONGS_TO, 'FoodPublicTarget', 'food_public_target_fk'],
        ];
    }
