...
class FoodMenuMealComponent extends TagModel
{
    ...
    public function relations()
    {
        ...
        return [
            'foodIngredients' => [self::HAS_MANY, 'FoodIngredient', 'food_menu_meal_componentId'],
            'foodMenuMeal' => [self::BELONGS_TO, 'FoodMenuMeal', 'food_menu_mealId'],
        ];
    }
