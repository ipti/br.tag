...
<div class="form">
    ...
    <div class="t-tabs">
        <ul class="tab-farmer t-tabs__list">
            <li id="tab-farmer" class="active t-tabs__item">
                <a class="t-tabs__link" href="#farmer" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="farmer-deliveries">
            ...
            <div id="requestFoodRelation"></div>
        </div>
    </div>
