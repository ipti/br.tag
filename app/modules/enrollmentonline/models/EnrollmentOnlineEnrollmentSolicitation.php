 ...
 * @property int $enrollment_online_student_identification_fk
 * @property int $status
 *
...
class EnrollmentOnlineEnrollmentSolicitation extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return [
            ...
            'enrollmentOnlineStudentIdentificationFk' => [self::BELONGS_TO, 'EnrollmentOnlineStudentIdentification', 'enrollment_online_student_identification_fk'],
        ];
    }
