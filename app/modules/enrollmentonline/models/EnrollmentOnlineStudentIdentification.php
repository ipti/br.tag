...
class EnrollmentOnlineStudentIdentification extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, birthday, sex, color_race, deficiency', 'required'),
			array('classroom_fk, sex, color_race, deficiency, deficiency_type_blindness, deficiency_type_low_vision, deficiency_type_deafness, deficiency_type_disability_hearing, deficiency_type_deafblindness, deficiency_type_phisical_disability, deficiency_type_intelectual_disability, deficiency_type_multiple_disabilities, deficiency_type_autism, deficiency_type_gifted, zone, edcenso_city_fk, edcenso_uf_fk, unavailable, student_fk, edcenso_stage_vs_modality_fk, event_pre_registration_fk, stages_vacancy_pre_registration_fk', 'numerical', 'integerOnly'=>true),
			...
			array('classroom_inep_id, classroom_fk, id, name, birthday, cpf, sex, color_race, deficiency, deficiency_type_blindness, deficiency_type_low_vision, deficiency_type_deafness, deficiency_type_disability_hearing, deficiency_type_deafblindness, deficiency_type_phisical_disability, deficiency_type_intelectual_disability, deficiency_type_multiple_disabilities, deficiency_type_autism, deficiency_type_gifted, last_change, mother_name, father_name, responsable_name, responsable_cpf, responsable_telephone, cep, address, number, complement, neighborhood, zone, edcenso_city_fk, edcenso_uf_fk, unavailable, student_fk, edcenso_stage_vs_modality_fk, event_pre_registration_fk, stages_vacancy_pre_registration_fk, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'deficiency_type_blindness' => 'Deficiency Type Blindness',
			'deficiency_type_low_vision' => 'Deficiency Type Low Vision',
			'deficiency_type_deafness' => 'Deficiency Type Deafness',
			'deficiency_type_disability_hearing' => 'Deficiency Type Disability Hearing',
			'deficiency_type_deafblindness' => 'Deficiency Type Deafblindness',
			'deficiency_type_phisical_disability' => 'Deficiency Type Phisical Disability',
			'deficiency_type_intelectual_disability' => 'Deficiency Type Intelectual Disability',
			'deficiency_type_multiple_disabilities' => 'Deficiency Type Multiple Disabilities',
			'deficiency_type_autism' => 'Deficiency Type Autism',
			'deficiency_type_gifted' => 'Deficiency Type Gifted',
			'last_change' => 'Last Change',
			'mother_name' => 'Mother Name',
			'father_name' => 'Father Name',
			'responsable_name' => 'Responsable Name',
			'responsable_cpf' => 'Responsable Cpf',
			...
			'event_pre_registration_fk' => 'Event Pre Registration Fk',
			'stages_vacancy_pre_registration_fk' => 'Stages Vacancy Pre Registration Fk',
