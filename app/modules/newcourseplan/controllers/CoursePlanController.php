...
class CoursePlanController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['CoursePlan'])) {
            $model->attributes = $_POST['CoursePlan'];
            if ($model->save())
    ...
    public function actionUpdate($id)
    {
        ...
        $stages = EdcensoStageVsModality::getValidStages();
    ...
    {
        $model = new CoursePlan('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['CoursePlan']))
            $model->attributes = $_GET['CoursePlan'];
    ...
    {
        $model = CoursePlan::model()->with('courseClasses')->findByPk($id);
        if ($model === null)
