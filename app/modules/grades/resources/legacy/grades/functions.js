...
function loadDisciplinesFromClassroom(classroomId) {
    ...
    if (classroomId !== "") {
        $.ajax({
            type: "POST",
            url: "?r=grades/default/getDisciplines",
            cache: false,
            data: {
...
function loadUnitiesFromClassroom(classroomId) {
    ...
    if(classroomId !== "")
    {
        $.ajax({
            type: "POST",
            url: "?r=grades/default/getUnities",
            cache: false,
            data: {
                classroom: classroomId,
                stage: stage,
...
function loadStudentsFromDiscipline(disciplineId, unityId) {
    ...
    if (discipline && unity && discipline !== "" && unity !== "") {
        ...
        $.ajax({
            type: "POST",
            url: "?r=grades/default/getGrades",
            cache: false,
            data: {
                classroom: classroom,
            ...
            success: function (data) {
                ...
                let hrefPrintGrades = `/?r=schoolreport/forms/AtaSchoolPerformance&id=${classroom}`
