...
<div class="main">
    ...
    <div class="column js-grades-container">
        ...
        <div class="column js-grades-rules-container is-three-fifths" style="display: none;">
            ...
            <p class="subheading">Configure as regras básicas para aprovação dos alunos</p>
            <div class="t-field-select">
                <label class="t-field-select__label--required">Modelo de avalição</label>
            ...
            <div class="numeric-fields t-field-select">
                <label class="t-field-select__label--required">Calculo da média final</label>
            ...
            <div class="numeric-fields t-field-text">
                <label class="t-field-text__label--required">Média de Aprovação</label>
                <input type="text" class="approval-media t-field-text__input">
            </div>
            <div class="numeric-fields t-field-checkbox">
                <?php echo CHtml::checkbox('has_final_recovery', false, array('class' => 't-field-checkbox__input js-has-final-recovery')) ?>
        ...
        <div class="column js-grades-rules-container" style="display: none;">
            ...
            <p class="subheading">Gerencie a quantidade de unidades avaliativas, elas podem ser bimestres, semestres e outros</p>
        </div>
        ...
        <div class="column js-grades-rules-container js-partial-recoveries-header" style="display: none;">
            ...
            <p class="subheading">Gerencie a quantidade de recuperações parciais</p>
        </div>
        <div class="row">
            <div class="column is-three-fifths">
                <div id="accordion-partial-recovery" class="t-accordeon-quaternary js-partial-recoveries-container"></div>
            </div>
        </div>
        ...
        <div class="column js-recovery-form  is-three-fifths" style="display: none;">
            ...
            <div class="t-field-text js-recovery-media-visibility">
                <label class="t-field-text__label--required">Média de Rec. Final</label>
        ...
        <form method="post">
            <div class="modal-body">
                ...
                <div class="modal-footer" style="margin-top: 50px">
                    ...
                    <button type="button" class="btn btn-primary js-save-and-reply-button" data-dismiss="modal">Salvar e Replicar</button>
                </div>
            </div>
        </form>
    </div>
