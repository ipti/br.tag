    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="t-buttons-container">
                <a class="t-button-primary" href="<?php echo Yii::app()->createUrl('grades/structure/create') ?>">Adicionar Estrutura</a>
            </div>
        </div>
    </div>
    <div class="tag-inner">
                ...
                $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            'name' => 'nome',
                            'type' => 'raw',
                            'value' => 'CHtml::link($data->name, Yii::app()->createUrl("grades/structure/create", array("id" => $data->id)))',
                        ),
                        array(
                            'name' => 'Ano',
                            'type' => 'raw',
                        ...
                        array(
                            ...
                            'value' =>
                                'CHtml::link("", "#", array(' .
                                    ...
                                    '"data-name" => $data->name,' .
                                ')) . " " .' .
                                'CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/img/editar.svg"), Yii::app()->createUrl("grades/structure/create", array("id" => $data->id)), array("title" => "Editar")) . " " .' .
                                'CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/img/deletar.svg"), Yii::app()->createUrl("grades/structure/delete", array("id" => $data->id)), array("title" => "Excluir"))',
                        ),
                    ),
                ));
                ?>
...
<div id="modal-copy-structure" class="modal fade t-modal-container" tabindex="-1" aria-labelledby="modalCopyLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form id="form-copy-structure" method="GET" action="/">
            <input type="hidden" name="r" value="grades/structure/copy">
