...
$cs->registerScriptFile($baseScriptUrl . '/legacy/gradesRelease/_initialization.js?v=' . TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseScriptUrl . '/legacy/gradesRelease/functions.js?v=' . TAG_VERSION, CClientScript::POS_END);
