...
$baseScriptUrl = $this->module->baseScriptUrl;
$cs = Yii::app()->getClientScript();
$cs->registerScriptFile($baseScriptUrl . '/legacy/grades/functions.js?v=' . TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseScriptUrl . '/legacy/grades/_initialization.js?v=' . TAG_VERSION, CClientScript::POS_END);

$script = "var getGradesUrl = '" . Yii::app()->createUrl('grades/default/getGrades') . "';";
...
<div class="main">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        ...
        'action' => CHtml::normalizeUrl(array('grades/default/saveGrades')),
    ));
    ?>
    <div class="row">
        ...
        <div class="column clearleft  is-four-fifths row wrap">
            ...
            <div class="column clearleft">
                <div class="t-field-select">
                    ...
                    <?php echo CHtml::dropDownList('discipline', '', array(), array(
                        'key' => 'id',
            ...
            <div class="column clearleft js-stage-select js-hide-stage">
                ...
                <?php echo CHtml::dropDownList('stage', '', array(), array(
                    'key' => 'id',
                    'class' => 'select-search-on t-field-select__input select2-container',
                    'prompt' => 'Selecione...',
                )); ?>
            ...
            <div class="column clearleft">
                ...
                <?php echo CHtml::dropDownList('unities', '', array(), array(
                    'key' => 'id',
                    'class' => 'select-search-on t-field-select__input select2-container',
                    'prompt' => 'Selecione...',
                )); ?>
