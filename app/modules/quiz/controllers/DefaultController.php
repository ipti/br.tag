...
class DefaultController extends Controller
{
    ...
    public function actionQuiz()
    {
        ...
        $dataProvider = new CActiveDataProvider('Quiz', ['pagination' => false]);
    ...
    public function actionGroup()
    {
        ...
        $dataProvider = new CActiveDataProvider('QuestionGroup', ['pagination' => false]);
    ...
    public function actionQuestionGroup()
    {
        ...
        $dataProvider = new CActiveDataProvider('QuestionGroupQuestion', ['pagination' => false]);
    ...
    public function actionQuestion()
    {
        ...
        $dataProvider = new CActiveDataProvider('Question', ['pagination' => false]);
