...
$cs->registerScriptFile($baseScriptUrl . '/js/form/_initialization.js?v=' . TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseScriptUrl . '/js/form/functions.js?v=' . TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseScriptUrl . '/js/form/validations.js?v=' . TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseScriptUrl . '/js/form/pagination.js?v=' . TAG_VERSION, CClientScript::POS_END);
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                ...
                                <?php echo $form->textField(
                                    ...
                                    'workers_social_worker',
                                    [
                                        'placeholder' => 'Digite o Número de Assistentes Sociais',
                                        'class' => 't-field-text__input'
                                    ]
                                ); ?>
                                <?php echo $form->error(
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-checkbox-group clear-margin--top dependencies-container">
                                ...
                                <div class="t-field-checkbox">
                                    ...
                                    <label class="t-field-checkbox">
                                        <?php echo SchoolStructure::model()->attributeLabels()['dependencies_robotics_lab']; ?>
                                    </label>
                                </div>
                                <div class="t-field-checkbox">
                                    <?php echo $form->checkBox(
                        ...
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-checkbox-group equipments-material-container">
                                ...
                                <div class="t-field-checkbox">
                                    ...
                                    <label class="t-field-checkbox">
                                        <?php echo SchoolStructure::model()->attributeLabels()['equipments_audiovisual_student_production']; ?>
                                    </label>
                                </div>
                                <div class="t-field-checkbox">
                                    <?php echo $form->checkBox(
                                ...
                                <div class="t-field-checkbox">
                                    ...
                                    <label class="t-field-checkbox">
                                        <?php echo SchoolStructure::model()->attributeLabels()['equipments_robotics_kit']; ?>
                                    </label>
                                </div>
                                <div class="t-field-checkbox">
                                    <?php echo $form->checkBox(
                                ...
                                <div class="t-field-checkbox">
                                    ...
                                    <label class="t-field-checkbox">
                                        <?php echo SchoolStructure::model()->attributeLabels()['equipments_emotional_education_materials']; ?>
                                    </label>
                                </div>
                                <div class="t-field-checkbox">
                                    <?php echo $form->checkBox(
