<table class="table-border" role="presentation">
    <tr class="font-bold text-center text-uppercase">
        ...
        <td class="no-padding no-border-top">
            <table class="blue-background" role="presentation">
                <tr>
            ...
            <table role="presentation">
                <tr>
                    <? for ($i = 1; $i <= 4; $i++): ?>
            <td class="width-3 <?= $i == 1 ? 'no-border-left' : ''?>
                    <?= $i == 4 ? 'no-border-right' : ''?>" colspan="2">
                    <? if ($i == 1)
        echo 'Infantil I'; ?>
              <? if ($i == 2)
        echo 'Infantil II'; ?>
        ...
        <tr>
          <? for ($i = 1; $i <= 4; $i++): ?>
            <td class="width-1 <?= $i == 1 ? 'no-border-left' : ''?>
                    <?= $i == 4 ? 'no-border-right' : ''?> no-border-bottom">M
        </td>
        <td
            class="width-1 <?= $i == 1 ? 'no-border-left' : ''?> <?= $i == 4 ? 'no-border-right' : ''?> no-border-bottom">
            F</td>
        <?
endfor; ?>
        </tr>
  ...
  <tr>
    ...
    <td class="no-padding">
      <table role="presentation">
        ...
        <?= $j == 4 ? 'no-border-right' : ''?> no-border-bottom no-border-top">
        <div class="contentEditable no-border" contenteditable="true"></div>
        </td>
        <td
            class="width-1 <?= $j == 1 ? 'no-border-left' : ''?> <?= $j == 4 ? 'no-border-right' : ''?> no-border-bottom no-border-top">
            <div class="contentEditable no-border" contenteditable="true"></div>
        </td>
        <?
endfor; ?>
  ...
  <tr>
    ...
    <td class="no-padding">
      <table role="presentation">
        ...
        <?= $j == 1 ? 'no-border-left' : ''?>
        <?= $j == 4 ? 'no-border-right' : ''?> no-border-top">
        <div class="contentEditable no-border" contenteditable="true"></div>
        </td>
        <td
            class="width-1 <?= $i == 3 ? 'no-border-bottom' : ''?> <?= $j == 1 ? 'no-border-left' : ''?> <?= $j == 4 ? 'no-border-right' : ''?> no-border-top">
            <div class="contentEditable no-border" contenteditable="true"></div>
        </td>
        <?
    endfor; ?>
  ...
  <tr>
    ...
    <td
        class="width-1 <?= $i == 2 ? 'no-border-bottom' : ''?> <?= $j == 1 ? 'no-border-left' : ''?> <?= $j == 4 ? 'no-border-right' : ''?> no-border-top">
        <div class="contentEditable no-border" contenteditable="true"></div>
    </td>
    <?
    endfor; ?>
