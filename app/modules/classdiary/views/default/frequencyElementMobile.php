<table class="column tag-table-secondary js-table-frequency">
    ...
    <tbody>
        ...
        foreach ($frequency as $f) {
           echo "<tr>
                    <td> <a class='js-justification' href='".yii::app()->createUrl('classdiary/default/StudentClassDiary', array('student_id' => $f["studentId"], 'stage_fk' => $_GET["stage_fk"], 'classrom_id' => $_GET["classrom_fk"], 'schedule' => $f["schedule"]["schedule"], 'date' => $date))."'>".$f["studentName"]."</a></td>
