...
<div class="main">
    ...
    <div class="t-filter-bar">
        ...
        <div class="t-filters">
            ...
            <a class=" clear-margin--all t-button-primary t-button-primary--icon show--mobile js-change-date"><span class="t-icon-search_icon"></span></a>
        </div>
    </div>
    <div class="row">
        <div class="column t-multiselect clear-margin--x">
