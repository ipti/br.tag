            ...
            <div class="hide js-add-new-class-content-form">
                ...
                <div class="row t-field-text">
                    <div class="t-field-tarea t-margin-none--bottom clearfix column is-two-fifths">
                        ...
                        <textarea id="class-content"
                            class="t-field-tarea__input course-class-content js-class-content-textarea"
                            placeholder="Digite o conteúdo ministrado" rows="10"></textarea>
                    </div>
                </div>
                <div class="row t-field-text">
                    <div class="t-field-text clearfix column is-two-fifths">
                        <label for="class-content-methodology"
                            class="t-field-select__label--required">Metodologia</label>
                        <textarea for="class-content-methodology"
                            class="t-field-tarea__input course-class-methodology js-class-content-methodology"
                            placeholder="Digite o conteúdo ministrado" rows="10"></textarea>
                    </div>
                </div>
                <div class="row">
