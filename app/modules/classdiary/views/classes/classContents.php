...
$cs->registerScriptFile($baseScriptUrl . '/legacy/classes/class-contents/_initialization.js?v=' . TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseScriptUrl . '/legacy/classes/class-contents/functions.js?v=' . TAG_VERSION, CClientScript::POS_END);
...
$form = $this->beginWidget('CActiveForm', array(
    ...
    'action' => CHtml::normalizeUrl(array('/classdiary/classes/saveClassContents')),
));
            ...
            <form method="post">
                ...
                <div class="t-modal__body">
                    ...
                    <div class="t-modal__footer row reverse">
                        ...
                        <div class="t-buttons-container justify-content--center">
                            <button type="button" class="t-button-primary clear-margin--right js-add-classroom-diary"
