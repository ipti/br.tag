        ...
        success: function (response) {
            ...
            if (data.valid) {
                ...
                $.each(data.students[0].schedules, function () {
                    dayRow +=
                        "<th>" +
                        (pad(this.day, 2) + "/" + pad(monthSplit[1], 2)) +
                        "/" +
                        monthSplit[0] +
                        "</th>";

                    checkboxRow +=
                        "<th class='frequency-checkbox-general frequency-checkbox-container " +
                ...
                html +=
                    "<tr class='day-row sticky'><th class='sticky-column'></th>" +
                    dayRow +
                    "<tr class='checkbox-row'><th class='checkbox-row sticky-column'></th>" +
                    checkboxRow +
                    "</tr>";
                html += "</thead></div><tbody class='t-accordion__body'>";
                $.each(data.students, function (indexStudent, student) {
                    html +=
                        "<tr><td class='student-name sticky-column'>" +
                    ...
                    $.each(
                        ...
                        function (indexSchedule, schedule) {
                            ...
                            html +=
                                "<td class='frequency-checkbox-student frequency-checkbox-container " +
                                (!this.available || !schedule.valid
                                    ? "disabled"
                                    : "") +
                                "'><input class='frequency-checkbox' type='checkbox' " +
                ...
                if ($(checkbox).is(":checked")) {
                    $(
                        ...
                        if (
                            !$(this)
                                .parent()
                                .find(".frequency-justification-icon").length
                        ) {
                            $(this)
                                .parent()
                                .append(
