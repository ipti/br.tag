...
?>
    ...
    <div class="row-fluid box-professional">
        <div class="span12">
            <h1>
                <?php echo Yii::t('default', 'Professional Identifications')?>
            </h1>
            <div class="t-buttons-container">
                <a class="t-button-primary"
                    href="<?php echo Yii::app()->createUrl('professional/default/create')?>">Adicionar profissional</a>
            </div>
        </div>
        <div class="btn-group pull-right mt-30 responsive-menu dropdown-margin">
            ...
            <ul class="dropdown-menu">
                <li><a href="<?php echo Yii::app()->createUrl('professional/default/create')?>"><i></i> Adicionar
                        profissional</a></li>
            </ul>
        </div>
    </div>
