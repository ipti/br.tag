            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="container-box">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/createUser') ?>">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/gradesStructure') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/editPassword', array("id" => Yii::app()->user->loginInfos->id)) ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/exportmaster') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/manageUsers') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/activeDisableUser') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/instanceConfig') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/changelog') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('admin/admin/auditory') ?>">
                            <button type="button" class="admin-box-container">
                                <div class="pull-left" style="margin-right: 20px;">
