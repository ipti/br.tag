...
$cs->registerScriptFile($baseScriptUrl . '/js/admin/activeDisableUser/_initialization.js?v='.TAG_VERSION, CClientScript::POS_END);
                        ...
                        <?php foreach ($users as $user) {?>
                            <tr>
                                <td class="link-update-grid-view" tabindex="0">
                                    <a href="/?r=admin/admin/update&id=<?=$user->id?>" style="cursor: pointer;"><?= $user->name?></a>
                                </td>
                                <td><?= $user->username?></td>
                                <td style="text-align:center;">
                                    <a href="/?r=admin/admin/<?php echo $user->active ? "disable" : "active"?>User&id=<?=$user->id?>" style="cursor: pointer;">
