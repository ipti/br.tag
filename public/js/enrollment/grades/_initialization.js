            ...
            success: function (data) {
                ...
                if (data.valid) {
                    ...
                    var html =
                        ...
                        "'><thead><tr><th colspan='" +
                        tableColspan +
                        "' class='table-title'>Notas</th></tr><tr><th></th>";
                    ...
                    $.each(data.students, function () {
                        html +=
                            "<tr><td class='grade-student-name'><input type='hidden' class='enrollment-id' value='" +
                            this.enrollmentId +
                            "'>" +
                        ...
                        $.each(this.grades, function () {
                            ...
                            if (!data.isUnityConcept) {
                                html +=
                                    "<input type='text' class='grade' modalityid='" +
                                    this.modalityId +
                                    "' value='" +
                                    valueGrade +
                                    "'>";
