...
export default class AdvisorForm extends Component{
    ...
    load = async () => {
        ...
        await api.get(`/notice/${this.props.match.params.noticeID}`).then((response)=>{
            this.setState({
    ...
    handleSubmit = async()=>{
        ...
        await api.put(`/notice/${this.props.match.params.noticeID}`,data).then(()=>{
            successalert();
            this.clearState();
        ...
        return(
            <div className="row justify-content-md-center">
                <div className="col-md-12">
                    <RctCollapsibleCard heading="Editar documento noticeiro">
                        <Form>
