...
export default class NoticeForm extends Component{
    ...
    handleClickTest = (event) =>{
     ...
     async handleSubmit(){
        ...
        await api.post('/notice',data).then(()=>{
            successalert();
          this.clearState();
        })
        .catch((error)=>{
        ...
        return(
            <div className="row justify-content-md-center">
                <div className="col-md-12">
                    <RctCollapsibleCard heading="Adicionar edital">
                        <Form>
                            <Section title="Dados do documento:" icon="account-box" />
                            <div className="row">
                                <div className="col-sm-12 col-md-8">
                                    <FormGroup>
                                        <Label for="name"><h4>Título do edital:</h4></Label>
                                ...
                                <div className="col-sm-12 col-md-4">
                                    <Label for="advisorImage"><h4>Selecionar arquivo a ser publicado:</h4></Label>
