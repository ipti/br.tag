...
RUN chown -R www-data:www-data /app/app/runtime \
    ...
    && mkdir -p /app/app/export/SagresEdu && chown -R www-data:www-data /app/app/export \
    && mkdir -p /app/app/import && chown -R www-data:www-data /app/app/import
