...
if (simple == '1') {
    var tabs = ['tab-student-identify', 'tab-student-address', 'tab-student-enrollment', 'tab-student-deficiency'];
}else{
    var tabs = ['tab-student-identify', 'tab-student-documents', 'tab-student-address', 'tab-student-enrollment', 'tab-student-deficiency'];
}
