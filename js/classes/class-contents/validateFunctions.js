function createValidateTable(data) {
    ...
    $('#given-classes').html('<div class="t-badge-info t-margin-none--left"><b>Total de carga horária: </b>' + data.totalClasses + '</div><div class="t-badge-info t-margin-none--left"><b>Total de aulas ministradas: </b>' + data.totalClassContents + '</div>')
