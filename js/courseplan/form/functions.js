...
function format(d) {
    ...
    var $objectiveInput = $('<textarea class="course-class-objective" placeholder="Digite o Objetivo do Plano" id="objective-' + d.class + '" name="course-class[' + d.class + '][objective]">' + d.objective + '</textarea>');
