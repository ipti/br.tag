...
<div class="row-fluid  hidden-print">
    <div class="span12">
        ...
        <div class="tag-buttons-container buttons">
            <?php echo CHtml::htmlButton('<i></i>' . ($question->isNewRecord ? Yii::t('default', 'Create') : Yii::t('default', 'Save')), ['id' => 'save_question_button', 'class' => 't-button-primary  next', 'type' => 'button']);
?>
            <?php
if (!$question->isNewRecord) {
    echo CHtml::htmlButton('<i></i>' . Yii::t('default', 'Delete'), ['id' => 'delete_question_button', 'class' => 't-button-primary  next', 'type' => 'button']);
}
?>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="column">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($question, 'description', ['class' => 'control-label t-field-text__label--required']); ?>
                                <?php echo $form->textField($question, 'description', ['size' => 60, 'maxlength' => 255, 'class' => 't-field-text__input']); ?>
                            ...
                            <div class="t-field-select">
                                <?php echo $form->labelEx($question, 'type', ['class' => 'control-label t-field-text__label--required']); ?>
                                <?php
...
echo $form->dropDownList(
    ...
    'type',
    $question->getTypes(),
    ['prompt' => 'Selecione o Tipo', 'class' => 'select-search-on t-field-select__input']
); ?>
                                <?php echo $form->error($question, 'type'); ?>
                            </div>
                            <div class="t-field-select">
                                <?php echo $form->labelEx($question, 'status', ['class' => 'control-label t-field-text__label--required']); ?>
                                <?php
                ...
                <?php if (!$question->isNewRecord && in_array($question->type, $question->getEnableOption())) : ?>
                    <div class="tab-pane" id="option">
                        <div class="row">
                            <div class="column">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($option, 'description', ['class' => 't-field-text__label--required']); ?>
                                    <?php echo $form->textField($option, 'description', ['size' => 60, 'maxlength' => 255,  'class' => 't-field-text__input']); ?>
                                ...
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($option, 'answer', ['class' => 't-field-text__label--required']); ?>
                                    <?php echo $form->textField($option, 'answer', ['size' => 60, 'maxlength' => 255, 'class' => 't-field-text__input']); ?>
                                ...
                                <div class="t-field-checkbox">
                                    <?php echo $form->checkBox($option, 'complement', ['size' => 60, 'maxlength' => 150, 'class' => 't-field-checkbox__input']); ?>
                                    <?php echo $form->error($option, 'complement'); ?>
                                    <?php echo $form->labelEx($option, 'complement', ['class' => 't-field-text__label']); ?>
