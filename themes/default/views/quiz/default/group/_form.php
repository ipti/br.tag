...
<div class="row-fluid  hidden-print">
    <div class="span12">
        ...
        <div class="buttons">
            <?php echo CHtml::htmlButton('<i></i>' . ($group->isNewRecord ? Yii::t('default', 'Create') : Yii::t('default', 'Save')), ['id' => 'save_group_button', 'class' => 'btn btn-icon btn-primary last glyphicons circle_ok', 'type' => 'button']);
            ?>
            <?php
                if (!$group->isNewRecord) {
                    echo CHtml::htmlButton('<i></i>' . Yii::t('default', 'Delete'), ['id' => 'delete_group_button', 'class' => 'btn btn-icon btn-primary last glyphicons delete', 'type' => 'button']);
                }
            ?>
        </div>
    </div>
                        ...
                        <div class="row-fluid">
                            <div class=" span5">
                                <div class="control-group">                
                                    <?php echo $form->labelEx($group, 'name', ['class' => 'control-label']); ?>
                                    <div class="controls">
                                        <?php echo $form->textField($group, 'name', ['size' => 60, 'maxlength' => 150]); ?>
                ...
                [
                    ...
                    ':final_date' => date('Y-m-d'),
                                        ...
                                        echo $form->dropDownList(
                                            ...
                                            ['prompt' => 'Selecione um Questionário', 'class' => 'select-search-on']
                                        ); ?>
