                    ...
                    $this->widget('zii.widgets.grid.CGridView', array(
                        ...
                        'columns' => array(
                            ...
                            array(
                                'name' => 'question_id',
                                'type' => 'raw',
                                'value' => 'CHtml::link($data->question_id,Yii::app()->createUrl("quiz/default/updateQuestionGroup", array("question_group_id"=>$data->question_group_id, "question_id"=>$data->question_id)))',
                            ))
                    ));
                    ?>
                </div>   
