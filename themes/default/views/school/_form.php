            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="school-addressContact">
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'cep', array('class' => 't-field-text__label')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'edcenso_uf_fk', array('class' => 't-field-select__label--required')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'edcenso_city_fk', array('class' => 't-field-select__label--required')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'location', array('class' => 't-field-select__label--required')); ?>
                                <?php echo $form->DropDownList($modelSchoolIdentification, 'location', array(null => 'Selecione a localização', 1 => 'Urbano', 2 => 'Rural'), array('class' => 'select-search-off t-field-select__input select2-container')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'id_difflocation', array('class' => 't-field-select__label--required')); ?>
                                <?php echo $form->DropDownList($modelSchoolIdentification, 'id_difflocation', array(null => 'Selecione a localização', 1 => 'Área de assentamento', 2 => 'Terra indígena', 3 => 'Área onde se localiza a comunidade remanescente de quilombos', 7 => 'A escola não está em área diferenciada'), array('class' => 'select-search-off t-field-select__input select2-container')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-select">
                                ...
                                <?php echo $form->labelEx($modelSchoolIdentification, 'edcenso_regional_education_organ_fk', array('class' => 't-field-select__label')); ?>
                                <?php
                                ...
                                $criteria->order = 'name';
                                echo $form->dropDownList($modelSchoolIdentification, 'edcenso_regional_education_organ_fk', CHtml::listData(EdcensoRegionalEducationOrgan::model()->findAll($criteria), 'code', 'name'), array('prompt' => 'Selecione o órgão', 'class' => 'select-search-on t-field-select__input select2-container')); ?>
                                <?php echo $form->error($modelSchoolIdentification, 'edcenso_regional_education_organ_fk'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'offer_or_linked_unity', array('class' => 't-field-select__label--required')); ?>
                                <?php echo $form->DropDownList($modelSchoolIdentification, 'offer_or_linked_unity', array(null => 'Selecione a localização', 0 => 'Não', 1 => 'Unidade vinculada a escola de Educação Básica', 2 => 'Unidade ofertante de Ensino Superior'), array('class' => 'select-search-off t-field-select__input select2-container')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'ddd', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolIdentification, 'ddd', array('size' => 2, 'maxlength' => 2, 'class' => 't-field-text__input', 'placeholder' => '(__)')); ?>
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'phone_number', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolIdentification, 'phone_number', array('size' => 9, 'maxlength' => 9, 'class' => 't-field-text__input','placeholder' => '_____-____')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'email', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolIdentification, 'email', array('size' => 50, 'maxlength' => 50, 'placeholder' => 'Digite o E-mail', 'class' => 't-field-text__input')); ?>
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolIdentification, 'other_phone_number', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolIdentification, 'other_phone_number', array('size' => 9, 'maxlength' => 9, 'placeholder' => '_____-____', 'class' => 't-field-text__input')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Only Numbers') . " " . Yii::t('help', 'Phone'); ?>"><i></i></span> -->
                ...
                <div class="tab-pane" id="school-structure">
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'classroom_count', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'classroom_count', array('placeholder' => 'Digite o Número de Salas de Aula', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'classroom_count'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'used_classroom_count', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'used_classroom_count', array('placeholder' => 'Digite o Número de Salas de Aulas em Uso', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'dependencies_climate_roomspublic', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'dependencies_climate_roomspublic', array('placeholder' => 'Digite o Número de Salas Climatizadas', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'dependencies_climate_roomspublic'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'dependencies_outside_roomspublic', array('class' => 't-field-text__label--required')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'dependencies_outside_roomspublic', array('placeholder' => 'Digite o Número de Salas utilizadas fora do prédio', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'dependencies_acessibility_roomspublic', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'dependencies_acessibility_roomspublic', array('placeholder' => 'Digite o Número de Salas com Acessibilidade', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'employees_count', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'employees_count', array('placeholder' => 'Digite o Total de Funcionários', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'employees_count'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_librarian', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_librarian', array('placeholder' => 'Digite o Número de Bibliotecários', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_administrative_assistant', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_administrative_assistant', array('placeholder' => 'Digite o Número de Auxiliares Administrativos', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'workers_administrative_assistant'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_firefighter', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_firefighter', array('placeholder' => 'Digite o Número de Bombeiros', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_service_assistant', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_service_assistant', array('placeholder' => 'Digite o Número de Auxiliares de Serviços Gerais', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'workers_service_assistant'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_speech_therapist', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_speech_therapist', array('placeholder' => 'Digite o Número de Fonoaudiólogos', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_coordinator_shift', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_coordinator_shift', array('placeholder' => 'Digite o Número de Coordenadores', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'workers_coordinator_shift'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_psychologist', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_psychologist', array('placeholder' => 'Digite o Número de Psicólogos', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_nutritionist', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_nutritionist', array('placeholder' => 'Digite o Número de Nutricionistas', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'workers_nutritionist'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_cooker', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_cooker', array('placeholder' => 'Digite o Número de Cozinheiros ou Merendeiras', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_school_secretary', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_school_secretary', array('placeholder' => 'Digite o Número de Secretário(a)s', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'workers_school_secretary'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_support_professionals', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_support_professionals', array('placeholder' => 'Digite o Número de Profissionais de Apoio Pedagógico', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_security_guards', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_security_guards', array('placeholder' => 'Digite o Número de Seguranças', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'workers_security_guards'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'workers_monitors', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'workers_monitors', array('placeholder' => 'Digite o Número de Monitores', 'class' => 't-field-text__input')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            ...
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'building_occupation_situation', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->DropDownList($modelSchoolStructure, 'building_occupation_situation', array(null => "Selecione a forma de ocupação", "1" => "Próprio", "2" => "Alugado", "3" => "Cedido"), array('class' => 'select-search-off t-field-select__input select2-container')); ?>
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            ...
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'shared_school_inep_id_1', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->dropDownList($modelSchoolStructure, 'shared_school_inep_id_1', CHtml::listData(SchoolIdentification::model()->findAll(), 'inep_id', 'name'), array('multiple' => true, 'key' => 'inep_id', 'class' => 'select-schools t-field-select__input select2-container multiselect')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            ...
                            <div class="t-field-checkbox clear-margin--top ">
                                ...
                                <label class="t-field-text__label">
                                    <?php echo SchoolStructure::model()->attributeLabels()['supply_food']; ?>
                                </label>
                            </div>
                            <div class="t-field-select--required">
                                <?php echo $form->labelEx($modelSchoolStructure, 'feeding', array('class' => 't-field-select__label--required')); ?>
                                <?php echo $form->DropDownList($modelSchoolStructure, 'feeding', array(null => "Selecione o valor", "0" => "Não oferece", "1" => "Oferece"), array('class' => 'select-search-off t-field-select__input select2-container')); ?>
                ...
                <div class="tab-pane" id="school-manager">
                    ...
                    <div class="row">
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelManagerIdentification, 'email', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelManagerIdentification, 'email', array('size' => 50, 'maxlength' => 50, 'placeholder' => 'Digite o E-mail do Gestor', 'class' => 't-field-text__input', 'id' => 'ManagerIdentification_email')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-select">
                                ...
                                <?php
                                echo $form->dropDownList($modelManagerIdentification, 'edcenso_nation_fk', CHtml::listData(EdcensoNation::model()->findAll(array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione uma nação", 'class' => 'select-search-on t-field-select__input select2-container nationality-sensitive no-br', 'disabled' => 'disabled'));
                                ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-select">
                                ...
                                <?php
                                echo $form->dropDownList($modelManagerIdentification, 'edcenso_uf_fk', CHtml::listData(EdcensoUf::model()->findAll(array('order' => 'name')), 'id', 'name'),array('class' => 'select-search-off t-field-select__input select2-container',"disabled" => "disabled","prompt" => "Selecione uma cidade",));
                                ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelManagerIdentification, 'number_ato', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelManagerIdentification, 'number_ato', array( 'placeholder' => 'Digite o número ato', 'class' => 't-field-text__input')); ?>
                                <?php echo $form->error($modelManagerIdentification, 'number_ato'); ?>
                            </div>
                        </div>
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelManagerIdentification, 'contract_type', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->DropDownList($modelManagerIdentification, 'contract_type', array(null => "Selecione o vínculo", "1" => "Concursado/Efetivo", "2" => "Temporário", "3" => "Terceirizado", "4" => "CLT"), array('class' => 'select-search-off t-field-select__input select2-container')); ?>
                    ...
                    <div class="manager-filiation-container" style="display: none;">
                        <div class="row">
                            <div class="column is-two-fifths clearleft">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_1', array('class' => 't-field-text__label')); ?>
                                    <?php echo $form->textField($modelManagerIdentification, 'filiation_1', array('size' => 60, 'maxlength' => 100, "class" => "js-disabled-finputs js-finput-clear t-field-text__input", 'placeholder' => 'Digite o Nome Completo da filiação 1')); ?>
                                    <?php echo $form->error($modelManagerIdentification, 'filiation_1'); ?>
                                </div>
                            </div>
                            <div class="column clearleft--on-mobile is-two-fifths">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_2', array('class' => 't-field-text__label')); ?>
                                    <?php echo $form->textField($modelManagerIdentification, 'filiation_2', array('size' => 60, 'maxlength' => 100, "class" => "js-disabled-finputs js-finput-clear t-field-text__input", 'placeholder' => 'Digite o Nome Completo da filiação 2')); ?>
                        ...
                        <div class="row">
                            <div class="column is-two-fifths clearleft">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_1_cpf', array('class' => 't-field-text__label')); ?>
                                    <?php echo $form->textField($modelManagerIdentification, 'filiation_1_cpf', array('size' => 60, 'maxlength' => 14, "class" => "js-disabled-finputs js-finput-clear t-field-text__input", 'placeholder' => 'Digite o CPF da filiação 1')); ?>
                                    <?php echo $form->error($modelManagerIdentification, 'filiation_1_cpf'); ?>
                                </div>
                            </div>
                            <div class="column clearleft--on-mobile is-two-fifths">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_2_cpf', array('class' => 't-field-text__label')); ?>
                                    <?php echo $form->textField($modelManagerIdentification, 'filiation_2_cpf', array('size' => 60, 'maxlength' => 14, "class" => "js-disabled-finputs js-finput-clear t-field-text__input", 'placeholder' => 'Digite o CPF da filiação 2')); ?>
                        ...
                        <div class="row">
                            <div class="column is-two-fifths clearleft">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_1_rg', array('class' => 't-field-text__label')); ?>
                                    <?php echo $form->textField($modelManagerIdentification, 'filiation_1_rg', array('size' => 60, 'maxlength' => 45, "class" => "js-disabled-finputs js-finput-clear t-field-text__input", 'placeholder' => 'Digite o RG da filiação 1')); ?>
                                    <?php echo $form->error($modelManagerIdentification, 'filiation_1_rg'); ?>
                                </div>
                            </div>
                            <div class="column clearleft--on-mobile is-two-fifths">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_2_rg', array('class' => 't-field-text__label')); ?>
                                    <?php echo $form->textField($modelManagerIdentification, 'filiation_2_rg', array('size' => 60, 'maxlength' => 45, "class" => "js-disabled-finputs js-finput-clear t-field-text__input", 'placeholder' => 'Digite o RG da filiação 2')); ?>
                        ...
                        <div class="row">
                            <div class="column is-two-fifths clearleft">
                                <div class="t-field-select">
                                    <?php
                                    echo $form->labelEx($modelManagerIdentification, 'filiation_1_scholarity', array('class' => 't-field-select__label'));
                            ...
                            <div class="column clearleft--on-mobile is-two-fifths">
                                <div class="t-field-select">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_2_scholarity', array('class' => 't-field-select__label')); ?>
                                    <?php
                        ...
                        <div class="row">
                            <div class="column is-two-fifths clearleft">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_1_job', array('class' => 't-field-text__label')); ?>
                                    <?php echo $form->textField($modelManagerIdentification, 'filiation_1_job', array('size' => 60, 'maxlength' => 100, "class" => "js-disabled-finputs js-finput-clear t-field-text__input", 'placeholder' => 'Digite a Profissão da filiação 1')); ?>
                                    <?php echo $form->error($modelManagerIdentification, 'filiation_1_job'); ?>
                                </div>
                            </div>
                            <div class="column clearleft--on-mobile is-two-fifths">
                                <div class="t-field-text">
                                    <?php echo $form->labelEx($modelManagerIdentification, 'filiation_2_job', array('class' => 't-field-text__label')); ?>
                                    <?php echo $form->textField($modelManagerIdentification, 'filiation_2_job', array('size' => 60, 'maxlength' => 100, "class" => "js-disabled-finputs js-finput-clear t-field-text__input", 'placeholder' => 'Digite a Profissão da filiação 2')); ?>
                ...
                <div class="tab-pane" id="school-equipment">
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_dvd', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_dvd', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de DVDs')); ?>
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_vcr', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_vcr', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de VCRs')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Count') . " " . Yii::t('help', 'School equipment'); ?>"><i></i></span> -->
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_stereo_system', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_stereo_system', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Aparelhos de Som')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Count') . " " . Yii::t('help', 'School equipment'); ?>"><i></i></span> -->
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_data_show', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_data_show', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de DataShows')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Count') . " " . Yii::t('help', 'School equipment'); ?>"><i></i></span> -->
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_tv', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_tv', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Tvs')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Count') . " " . Yii::t('help', 'School equipment'); ?>"><i></i></span> -->
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_fax', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_fax', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Faxs')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Count') . " " . Yii::t('help', 'School equipment'); ?>"><i></i></span> -->
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_qtd_blackboard', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_qtd_blackboard', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Quadros Negros')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Count') . " " . Yii::t('help', 'School equipment'); ?>"><i></i></span> -->
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_camera', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_camera', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Máquinas Fotográficas')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Count') . " " . Yii::t('help', 'School equipment'); ?>"><i></i></span> -->
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_overhead_projector', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_overhead_projector', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Retroprojetores')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Count') . " " . Yii::t('help', 'School equipment'); ?>"><i></i></span> -->
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'administrative_computers_count', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'administrative_computers_count', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Computadores de Uso Administrativo')); ?>
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_qtd_desktop', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_qtd_desktop', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Computadores de Mesa (Desktop)')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Only Numbers') . " " . Yii::t('help', 'Count'); ?>"><i></i></span> -->
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'student_computers_count', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'student_computers_count', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Computadores de Uso Infantil')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Only Numbers') . " " . Yii::t('help', 'Count'); ?>"><i></i></span> -->
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_qtd_tabletstudent', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_qtd_tabletstudent', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Tablets de Uso Estudantil')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Only Numbers') . " " . Yii::t('help', 'Count'); ?>"><i></i></span> -->
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-text">
                                <?php echo $form->labelEx($modelSchoolStructure, 'equipments_qtd_notebookstudent', array('class' => 't-field-text__label')); ?>
                                <?php echo $form->textField($modelSchoolStructure, 'equipments_qtd_notebookstudent', array('size' => 4, 'maxlength' => 4, 'class' => 'equipments_input t-field-text__input', 'placeholder' => 'Digite o Número de Notebooks de Uso Estudantil')); ?>
                                <!-- <span class="btn-action single glyphicons circle_question_mark" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo Yii::t('help', 'Only Numbers') . " " . Yii::t('help', 'Count'); ?>"><i></i></span> -->
                    ...
                    <div class="row">
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            ...
                            <div class="t-field-checkbox-group internet-access-local-container">
                                <label class="t-field-checkbox-group__label--required"><?php echo Yii::t('default', 'Internet Access Local'); ?> *</label>
                                <div class="t-field-checkbox">
                ...
                <div class="tab-pane" id="school-education">
                    ...
                    <div class="row">
                        <div class="column is-two-fifths clearleft">
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'aee', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->DropDownList($modelSchoolStructure, 'aee', array(null => "Selecione o valor", "0" => "Não oferece", "1" => "Não exclusivamente", "2" => "Exclusivamente"), array('class' => 'select-search-off t-field-select__input select2-container')); ?>
                                <?php echo $form->error($modelSchoolStructure, 'aee'); ?>
                            </div>
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'complementary_activities', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->DropDownList($modelSchoolStructure, 'complementary_activities', array(null => "Selecione o valor", "0" => "Não oferece", "1" => "Não exclusivamente", "2" => "Exclusivamente"), array('class' => 'select-search-off t-field-select__input select2-container')); ?>
                            ...
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'different_location', array('class' => 't-field-select__label')); ?>
                                <?php
                            ...
                            <div class="t-field-checkbox-group">
                                <label class="t-field-checkbox-group__label"><?php echo Yii::t('default', 'Sociocultural Didactic Material'); ?></label>
                                <div class="t-field-checkbox">
                            ...
                            <div class="t-field-checkbox-group" id="native_education_language">
                                <label class="t-field-checkbox-group__label"><?php echo Yii::t('default', 'Native Education Language'); ?></label>
                            ...
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'edcenso_native_languages_fk', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->DropDownList($modelSchoolStructure, 'edcenso_native_languages_fk', CHtml::listData(EdcensoNativeLanguages::model()->findAll(array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione a língua indígena", 'class' => 'select-search-on t-field-select__input select2-container'));?>
                                <?php echo $form->error($modelSchoolStructure, 'edcenso_native_languages_fk'); ?>
                            </div>

                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'edcenso_native_languages_fk2', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->DropDownList($modelSchoolStructure, 'edcenso_native_languages_fk2', CHtml::listData(EdcensoNativeLanguages::model()->findAll(array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione a língua indígena", 'class' => 'select-search-on t-field-select__input select2-container'));
                                ?>
                                <?php echo $form->error($modelSchoolStructure, 'edcenso_native_languages_fk2'); ?>
                            </div>

                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'edcenso_native_languages_fk3', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->DropDownList($modelSchoolStructure, 'edcenso_native_languages_fk3', CHtml::listData(EdcensoNativeLanguages::model()->findAll(array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione a língua indígena", 'class' => 'select-search-on t-field-select__input select2-container'));
                                ?>
                        ...
                        <div class="column clearleft--on-mobile is-two-fifths">
                            <div class="t-field-checkbox-group clear-margin--top">
                                <label class="t-field-checkbox-group__label"><?php echo Yii::t('default', 'Modalities'); ?></label>
                                <div class="t-field-checkbox">
                            ...
                            <div class="t-field-checkbox-group">
                                <label class="t-field-checkbox-group__label"><?php echo Yii::t('default', 'Organization of Education'); ?></label>
                                <div class="t-field-checkbox">
                            ...
                            <div class="t-field-select">
                                <?php echo $form->labelEx($modelSchoolStructure, 'stages_concept_grades', array('class' => 't-field-select__label')); ?>
                                <?php echo $form->dropDownList($modelSchoolStructure, 'stages_concept_grades', CHtml::listData(EdcensoStageVsModality::model()->findAll(array('order' => 'name')), 'id', 'name'), array('multiple' => true, 'prompt' => 'Selecione o estágio vs modalidade', 'class' => 'select-search-on t-multiselect t-field-select__input select2-container multiselect')); ?>
