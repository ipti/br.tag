<div class='container-report mt-20'>
    <table class="table-border">
        ...
        <tr class="font-size-10">
            ...
            <table>
                <tr>
                <td class="size-col-3 no-border-top no-border-left no-border-bottom width-component">1° e 2° Séries</td>
                <td class="no-border-top no-border-right no-border-bottom">Resultados</td>
                </tr>
            </table>
            </td>
        ...
        <tr class="font-size-10">
            ...
            <table>
                <tr>
                <td class="no-border-top no-border-left no-border-bottom width-component">3° e 4° Séries</td>
                <td class="no-border-top no-border-right no-border-bottom">Resultados</td>
                </tr>
            </table>
            </td>
        ...
        <tr class="font-size-10">
            ...
            <table>
                <tr>
                <td class="no-border-top no-border-left no-border-bottom width-component">5° e 6° Séries</td>
                <td class="no-border-top no-border-right no-border-bottom">Resultados</td>
                </tr>
            </table>
            </td>
        ...
        <tr class="font-size-10">
            ...
            <table>
                <tr>
                <td class="size-col-3 no-border-top no-border-left no-border-bottom width-component">7° e 8° Séries</td>
                <td class="no-border-top no-border-right no-border-bottom">Resultados</td>
                </tr>
            </table>
            </td>
