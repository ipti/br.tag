  ...
  <tr class="font-bold text-center text-uppercase">
    ...
    <td class="no-padding no-border-top">
      ...
      <table>
        <tr>
          <?php for ($i = 1; $i <= 6; $i++): ?>
            <td class="<?= $i == 1 ? 'no-border-left' : '' ?> <?= $i == 6 ? 'no-border-right' : '' ?>" colspan="2"><?= $i != 6 ? $i . 'º Ano' : 'Total' ?></td>
          <?php endfor; ?>
        </tr>
        <tr>
          <?php for ($i = 1; $i <= 6; $i++): ?>
            <td class="width-1 <?= $i == 1 ? 'no-border-left' : '' ?> <?= $i == 6 ? 'no-border-right' : '' ?> no-border-bottom">M</td>
            <td class="width-1 <?= $i == 1 ? 'no-border-left' : '' ?> <?= $i == 6 ? 'no-border-right' : '' ?> no-border-bottom">F</td>
          <?php endfor; ?>
        </tr>
      </table>
    </td>
  ...
  <tr>
    ...
    <td class="no-padding">
      <table>
        <tr>
          <?php for ($j = 1; $j <= 6; $j++): ?>
            <td class="width-1 <?= $j == 1 ? 'no-border-left' : '' ?> <?= $j == 6 ? 'no-border-right' : '' ?> no-border-bottom no-border-top">
    ...
    <td class="no-padding">
      <table>
        <?php for ($i = 1; $i <= 3; $i++): ?>
          <tr>
            <?php for ($j = 1; $j <= 6; $j++): ?>
              <td class="width-1 <?= $i == 3 ? 'no-border-bottom' : '' ?> <?= $j == 1 ? 'no-border-left' : '' ?> <?= $j == 6 ? 'no-border-right' : '' ?> no-border-top">
                <div class="contentEditable no-border" contenteditable="true"></div>
              </td>
              <td class="width-1 <?= $i == 3 ? 'no-border-bottom' : '' ?> <?= $j == 1 ? 'no-border-left' : '' ?> <?= $j == 6 ? 'no-border-right' : '' ?> no-border-top">
                <div class="contentEditable no-border" contenteditable="true"></div>
    ...
    <td class="no-padding">
      <table>
        <?php for ($i = 1; $i <= 2; $i++): ?>
          <tr>
            <?php for ($j = 1; $j <= 6; $j++): ?>
              <td class="width-1 <?= $i == 2 ? 'no-border-bottom' : '' ?> <?= $j == 1 ? 'no-border-left' : '' ?> <?= $j == 6 ? 'no-border-right' : '' ?> no-border-top">
                <div class="contentEditable no-border" contenteditable="true"></div>
              </td>
              <td class="width-1 <?= $i == 2 ? 'no-border-bottom' : '' ?> <?= $j == 1 ? 'no-border-left' : '' ?> <?= $j == 6 ? 'no-border-right' : '' ?> no-border-top">
                <div class="contentEditable no-border" contenteditable="true"></div>
  ...
  <tr>
    ...
    <td class="no-padding">
      <table>
        <tr>
          <?php for ($j = 1; $j <= 6; $j++): ?>
            <td class="width-2 <?= $j == 1 ? 'no-border-left' : '' ?> <?= $j == 6 ? 'no-border-right' : '' ?> no-border-bottom no-border-top">
              <div class="contentEditable no-border" contenteditable="true"></div>
            </td>
          <?php endfor; ?>
        </tr>
