...
<div id="login">
   <!--  <div class="taglogo">
    ...
    <div class="taglogo">
        <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/faded-logo.png" style="width: 25%;position: absolute;top: 0;right: 0;z-index: -99;" />
    </div>
    <div class="form-signin">
                    <form method="post" action="index.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-light">
                        ...
                        ?>
                        <div class="uniformjs"><label class="checkbox text-input" ><input type="checkbox" style="margin: 4px 6px 40px 0"value="remember-me">Lembrar-me</label></div>
                        <div class="row-fluid">
                            <div>
