...
<div class="main">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        ...
        'action' => CHtml::normalizeUrl(array('classes/saveGradesStructure')),
    ));
    ?>
    <div class="row-fluid">
        <div class="span12">
    ...
    <div class="tag-inner">
        ...
        <div class="grades-structure-container">
            <div class="row">
                <a href="#new-unity" id="new-unity" class="t-button-primary">
                    <img alt="Nova unidade" src="/themes/default/img/buttonIcon/start.svg">Nova Unidade
                </a>
            </div>
        </div>
    </div>
