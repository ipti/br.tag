            ...
            <div class="tab-content">
                    ...
                    <div class="school-schedules row-fluid">
                        ...
                        <div class="span5">
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'morning_initial', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <!-- row -->
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'afternoom_initial', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <!-- row -->
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'night_initial', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <!-- row -->
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'allday_initial', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                        ...
                        <div class="span6">
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'morning_final', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <!-- row -->
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'afternoom_final', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <!-- row -->
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'night_final', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <!-- row -->
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'allday_final', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                ...
                <div class="tab-pane" id="exams">
                    <div class="test-dates row-fluid">
                        <div class=" span5">
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'exam1', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'exam2', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'exam3', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'exam4', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                        ...
                        <div class=" span6">
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'recovery1', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'recovery2', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'recovery3', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'recovery4', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <?php echo $form->labelEx($model, 'recovery_final', array('class' => 'control-label ml-10')); ?>
                                <div class="controls">
