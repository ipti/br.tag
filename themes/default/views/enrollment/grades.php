...
$cs->registerScriptFile($baseUrl . '/js/enrollment/grades/_initializationv='.TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile($baseUrl . '/js/enrollment/grades/functionsv='.TAG_VERSION, CClientScript::POS_END);
