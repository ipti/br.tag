            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="filterUsersTab">
                    <ul class="list-timeline">
                        ...
                        <?php if (count($log) == 0) : ?>
                            <div class="alert alert-success">Nenhuma pendência registrada.</div>
                            <div>
                        ...
                        <?php else: ?>
                            <div class="alert alert-error">
                                ...
                                <strong>Foram encontradas pendências para exportação de dados para o EDUCACENSO. Corrija
                                    primeiro para exportar o arquivo.</strong>
                            </div>
