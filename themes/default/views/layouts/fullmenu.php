...
if (
    ...
    || Yii::app()->getAuthManager()->checkAccess('superuser', Yii::app()->user->loginInfos->id)
        ...
        <div id="wrapper">
            ...
            <div class="t-drawer js-drawer hidden-print t-drawer--mobile-hidden">
                ...
                <div class="slim-scroll" data-scroll-height="800px">
                    <ul class="t-menu">
                        <?php if (Yii::app()->getAuthManager()->checkAccess('superuser', Yii::app()->user->loginInfos->id)): ?>
                            <li
                                class="t-menu-item <?= strpos($_SERVER['REQUEST_URI'], "?r=admin") || $_SERVER['REQUEST_URI'] == "/" ? 'active' : '' ?> hide-responsive">
                                <a href="<?= yii::app()->createUrl('admin/manageModules') ?>" class="t-menu-item__link">
                                    <span class="t-icon-settings t-menu-item__icon"></span>
                                    <span class="t-menu-item__text">Gerencdiar Módulos</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (
                            ...
                            <?php if (Yii::app()->features->isEnable("SCHOOL_MODULE")): ?>
                            ...
                            <?php endif; ?>
                            <?php if (Yii::app()->features->isEnable("CLASSROOM_MODULE")): ?>
                            ...
                            <?php endif; ?>
                            <?php if (Yii::app()->features->isEnable("STUDENT_MODULE")): ?>
                            ...
                            <?php endif; ?>
                            <?php if (Yii::app()->features->isEnable("INSTRUCTOR_MODULE")): ?>
                            ...
                            <?php endif; ?>
                            <?php if (Yii::app()->features->isEnable("CALENDAR_MODULE")): ?>
                                <li
                            ...
                            <?php endif; ?>
                            <?php if (Yii::app()->features->isEnable("CURRICULAR_MATRIX_MODULE")): ?>
                                <li
                            ...
                            <?php endif; ?>
                            <?php if (Yii::app()->features->isEnable("TIME_SHEET_MODULE")): ?>
                                <li
                        ...
                        <?php if (
                            ...
                            Yii::app()->features->isEnable("ELECTRONIC_DIARY_MODULE")
                        ): ?>
                            ...
                            <?php endif ?>
                            <?php if (Yii::app()->getAuthManager()->checkAccess('instructor', Yii::app()->user->loginInfos->id) && Yii::app()->features->isEnable("CLASS_DIARY_MODULE")): ?>
                                <li
                            ...
                            <?php endif ?>
                            <?php if ((Yii::app()->getAuthManager()->checkAccess('admin', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('superuser', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('manager', Yii::app()->user->loginInfos->id)
                                    || Yii::app()->getAuthManager()->checkAccess('reader', Yii::app()->user->loginInfos->id))
                                && Yii::app()->features->isEnable("REPORTS_MODULE")
                            ): ?>
                                <li
                            ...
                            <?php endif; ?>
                            <?php if (Yii::app()->getAuthManager()->checkAccess('admin', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('superuser', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('manager', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('reader', Yii::app()->user->loginInfos->id)): ?>
                                <?php if (Yii::app()->features->isEnable("QUIZ_MODULE")): ?>
                                    <li id="menu-quiz"
                                ...
                                <?php endif; ?>
                                <?php if (Yii::app()->features->isEnable("FOODS_MODULE")): ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if (Yii::app()->features->isEnable("INTEGRATIONS_MODULE")): ?>
                                    <li id="menu-integrations" class="t-menu-group <?=
                                            ...
                                            class="submenu-icon fa fa-chevron-down"></i>
                            ...
                            <?php if (Yii::app()->getAuthManager()->checkAccess('nutritionist', Yii::app()->user->loginInfos->id) && Yii::app()->features->isEnable("FOODS_MODULE")): ?>
                                <?php if (Yii::app()->features->isEnable("FEAT_FOOD")): ?>
                                    <li class="t-menu-item <?= strpos($_SERVER['REQUEST_URI'], "?r=foods") ? 'active' : '' ?>">
                                        <a class="t-menu-item__link" href="<?php echo yii::app()->createUrl('foods') ?> ">
                                            <span class="t-icon-apple t-menu-item__icon"></span>
                            ...
                            <?php if (
                                ...
                                <?php if (Yii::app()->features->isEnable("ADMIN_MODULE")): ?>
                                    <li
                                ...
                                <?php endif; ?>
                                <?php if (Yii::app()->features->isEnable("DASHBOARD_MODULE")): ?>
