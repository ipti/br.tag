...
if (Yii::app()->getAuthManager()->checkAccess('admin', Yii::app()->user->loginInfos->id)  || Yii::app()->getAuthManager()->checkAccess('nutritionist', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('reader', Yii::app()->user->loginInfos->id)) {
            ...
            <div class="t-drawer js-drawer hidden-print t-drawer--mobile-hidden">
                ...
                <div class="slim-scroll" data-scroll-height="800px">
                    <ul class="t-menu">
                        ...
                        <?php if (Yii::app()->getAuthManager()->checkAccess('admin', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('reader', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('manager', Yii::app()->user->loginInfos->id)) : ?>
                        ...
                        || Yii::app()->getAuthManager()->checkAccess('manager', Yii::app()->user->loginInfos->id)) : ?>
                                ...
                                <li id="menu-integrations" class="t-menu-group <?=
                                    ...
                                    <ul class="collapse <?=
                                        ...
                                        <li
                                            ...
                                            <a class="t-menu-item__link"
                                                href="<?php echo yii::app()->createUrl('censo/validate') ?> ">
                            ...
                            <?php if (Yii::app()->getAuthManager()->checkAccess('nutritionist', Yii::app()->user->loginInfos->id)): ?>
                                ...
                                ?>
                        <?php if (Yii::app()->getAuthManager()->checkAccess('admin', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('reader', Yii::app()->user->loginInfos->id)) { ?>
