...
<body>
                    ...
                    <ul class="t-menu">
                        <?php if (Yii::app()->getAuthManager()->checkAccess('guardian', Yii::app()->user->loginInfos->id)): ?>
                            <li
                                ...
                                <a href="<?php echo yii::app()->createUrl('enrollmentonline/Enrollmentonlinestudentidentification/StudentStatus') ?>"
                                    class="t-menu-item__link">
                        ...
                        <?php if (Yii::app()->getAuthManager()->checkAccess('admin', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('manager', Yii::app()->user->loginInfos->id) || Yii::app()->getAuthManager()->checkAccess('reader', Yii::app()->user->loginInfos->id)): ?>
                            ...
                            <li id="menu-integrations" class="t-menu-group <?=
                                ...
                                ? 'active' : '' ?>"><i class="submenu-icon fa fa-chevron-right"></i><i
                        ...
                        <?php } ?>
                        <li class="t-menu-item hide-responsive">
                            <a class="t-menu-item__link" href="<?php echo yii::app()->createUrl('enrollmentonline') ?>">
                                <span class="t-icon-backpack t-menu-item__icon"></span>
                                <span class="t-menu-item__text">Matricula Online</span>
                            </a>
                        </li>
                    </ul>
                </div>
  ...
  <script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery/jquery.qrcode.min.js" type="text/javascript">
  </script>
  <script
    src='<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery/fullcalendar/fullcalendar.min.js?v=<?= TAG_VERSION ?>'>
  </script>
