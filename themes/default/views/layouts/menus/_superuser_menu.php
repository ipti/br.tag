...
?>
    ...
    <li class="t-menu-item <?= strpos($_SERVER['REQUEST_URI'], " ?r=student") ? 'active' : '' ?>">
        <a class="t-menu-item__link" href="<?php echo Yii::app()->createUrl('student/student/index')?>">
    ...
    <li class="t-menu-item <?= strpos($_SERVER['REQUEST_URI'], " ?r=curricularmatrix") ? 'active' : '' ?>
        hide-responsive">
    ...
    <li id="menu-electronic-diary" class="t-menu-group <?=
        ...
        strpos($_SERVER['REQUEST_URI'], " ?r=courseplan") || strpos($_SERVER['REQUEST_URI'], "?r=classdiary/classes/classContents"
            ...
            <li class="t-menu-item <?= strpos($_SERVER['REQUEST_URI'], " ?r=macete/lessonsplan") || strpos($_SERVER['REQUEST_URI'], "?r=macete/lessonsplan") ? 'active' : '' ?>">
                <a class="t-menu-item__link" href="<?php echo Yii::app()->createUrl('macete/lessonsplan/index')?>">
                    <span class="t-icon-diary t-menu-item__icon"></span>
            ...
            <li class="t-menu-item <?= strpos($_SERVER['REQUEST_URI'], " ?r=macete/lessonsrecord") || strpos($_SERVER['REQUEST_URI'], "?r=macete/lessonsrecord") ? 'active' : '' ?>">
...
|| Yii::app()->getAuthManager()->checkAccess('reader', Yii::app()->user->loginInfos->id)
    ...
    <li id="menu-quiz" class="t-menu-item  <?= strpos($_SERVER['REQUEST_URI'], " ?r=quiz") ? 'active' : '' ?>
        hide-responsive">
    ...
    <li id="menu-integrations" class="t-menu-group <?=
        strpos($_SERVER['REQUEST_URI'], " ?r=censo/index") || strpos($_SERVER['REQUEST_URI'], "?r=sagres" ) ||
        strpos($_SERVER['REQUEST_URI'], "?r=gestaopresente" ) || strpos($_SERVER['REQUEST_URI'], "?r=sedsp" ) ? 'active'
        : '' ?>">
        <i class="submenu-icon fa fa-chevron-right"></i>
        <iclass="submenu-icon fa fa-chevron-down"></i>
            ...
            <ul class="collapse <?=
        strpos($_SERVER['REQUEST_URI'], " ?r=censo/index") || strpos($_SERVER['REQUEST_URI'], "?r=sagres" ) ||
                strpos($_SERVER['REQUEST_URI'], "?r=gestaopresente" ) || strpos($_SERVER['REQUEST_URI'], "?r=sedsp" )
                ? 'in' : '' ?>"
                id="submenu-integrations">
                <li class="t-menu-item <?= strpos($_SERVER['REQUEST_URI'], " ?r=censo/index") ? 'active' : '' ?>">
                    <a class="t-menu-item__link" href="<?php echo Yii::app()->createUrl('censo/index')?> ">
                ...
                <li class="t-menu-item <?= strpos($_SERVER['REQUEST_URI'], '?r=gestaopresente') ? 'active' : ''?>">
                    <a class="t-menu-item__link" href="<?php echo Yii::app()->createUrl('gestaopresente')?> ">
                        <span class="t-icon-educacenso t-menu-item__icon"></span>
