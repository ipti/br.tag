...
$cs->registerScript(
    'variables',
    "var URLGetMapInfos = '" . $this->createUrl('GetGMapInfo') . "';",
    CClientScript::POS_BEGIN
);
$cs->registerScriptFile($baseScriptUrl . '/common/js/index/loadMap.js?v=' . TAG_VERSION, CClientScript::POS_END);
$cs->registerScriptFile('https://maps.googleapis.com/maps/api/js?key=&callback=initMap', CClientScript::POS_END, ['async', 'defer']);
$cs->registerScriptFile('http://google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclusterer/src/markerclusterer.js?v=' . TAG_VERSION, CClientScript::POS_END);
