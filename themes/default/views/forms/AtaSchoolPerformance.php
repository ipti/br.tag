...
function classroomDisciplineLabelResumeArray($discipline_id)
{
    ...
    if ($discipline_id == 17) {
        $label = 'Disc. Profissionalizante';
    }
    if ($discipline_id == 20) {
        $label = 'Educação Especial';
    }
    if ($discipline_id == 21) {
        $label = 'Sociedade&nbspe Cultura';
    }
    if ($discipline_id == 23) {
        $label = 'Libras';
    }
    ...
    if ($discipline_id == 10001) {
        $label = 'Redação';
    }
    if ($discipline_id == 10002) {
        $label = 'Linguagem oral e escrita';
    }
    if ($discipline_id == 10003) {
        $label = 'Natureza e sociedade';
    }
    if ($discipline_id == 10004) {
        $label = 'Movimento';
    }
    if ($discipline_id == 10005) {
        $label = 'Música';
    }
    if ($discipline_id == 10006) {
        $label = 'Artes visuais';
    }
    if ($discipline_id == 10007) {
        $label = 'Escuta, Fala, Pensamento e Imaginação';
    }
    if ($discipline_id == 10008) {
        $label = 'Espaço, Tempo, Quantidade, Relações e Transformações';
    }
    if ($discipline_id == 10009) {
        $label = 'Corpo, Gesto e Movimento';
    }
    if ($discipline_id == 10010) {
        $label = 'Traços, Sons, Cores e Formas';
    }
    if ($discipline_id == 10011) {
        $label = 'O Eu, O Outro e o Nós';
    }
    if ($discipline_id == 10012) {
        $label = 'Manifestações Culturais e Artísticas Globais e Regionais';
    }
    if ($discipline_id == 10013) {
        $label = 'Gestão Sustentável de Detinos Turísticos';
    }
    if ($discipline_id == 10014) {
        $label = 'Lazer, Esporte e Trabalho';
    }
    if ($discipline_id == 10015) {
        $label = 'Inglês Instrumental';
    }
    if ($discipline_id == 10016) {
        $label = 'Espanhol Instrumental';
    }
    if ($discipline_id == 10017) {
        $label = 'Georgrafia Turística';
    }
    if ($discipline_id == 10018) {
        $label = 'Desafios contemporâneos: Do Global ao Local';
    }
    if ($discipline_id == 10019) {
        $label = 'História Regional';
    }
    if ($discipline_id == 10020) {
        $label = 'Sociedade Buziana';
    }
    if ($discipline_id == 10021) {
        $label = 'Antropologia Sociocultural';
    }
    if ($discipline_id == 10022) {
        $label = 'Patrimônios Culturais';
    }
    if ($discipline_id == 10023) {
        $label = 'Literatura na Era Digital';
    }
    if ($discipline_id == 10024) {
        $label = 'Educação Financeira';
    }
    if ($discipline_id == 10025) {
        $label = 'Expressão Oral e Escrita';
    }
    if ($discipline_id == 10026) {
        $label = 'Projeto de Vida II';
    }
    if ($discipline_id == 10027) {
        $label = 'Língua Espanhola';
    }
    if ($discipline_id == 10028) {
        $label = 'Análise e Experimentação científica';
    }
    if ($discipline_id == 10029) {
        $label = 'Consciência Ecológica e Educação Ambiental';
    }
    if ($discipline_id == 10030) {
        $label = 'Ciências, Tecnologia e Sociedade';
    }
    if ($discipline_id == 10031) {
        $label = 'Pensamento Lógico-Matemático';
    }
    if ($discipline_id == 10032) {
        $label = 'Cálculo';
    }
    if ($discipline_id == 10033) {
        $label = 'Sustentabilidade';
    }
    if ($discipline_id == 10034) {
        $label = 'Eficiência Energética';
    }
    if ($discipline_id == 10035) {
        $label = 'Corpo e Movimento';
    }
    if ($discipline_id == 10036) {
        $label = 'Geometria';
    }
    if ($discipline_id == 10037) {
        $label = 'Corpo e Saúde';
    }
    if ($discipline_id == 10038) {
        $label = 'Ciências Biológicas, Agrárias e da Saúde';
    }
    if ($discipline_id == 10039) {
        $label = 'Projeto de vida I';
    }
    if ($discipline_id == 10040) {
        $label = 'Projeto de Leitura';
    }
    if ($discipline_id == 10041) {
        $label = 'Pluralidade Cultural';
    }
    if ($discipline_id == 10042) {
        $label = 'Estudo Dirigido: Atividade de Lingua Portuguesa e de Matmática';
    }
    if ($discipline_id == 10043) {
        $label = 'Atividades Esportivas e Motoras';
    }
