...
<div class="pageA4H">
    ...
    <h3><?php echo Yii::t('default', 'Students With Disabilities Per Classroom Relation'); ?></h3>
    ...
    <?php
    if(count($students) == 0) {
        echo "<br><span class='alert alert-primary'>Não existem alunos PCD cadastrados nessa turma</span>";
    } else {
