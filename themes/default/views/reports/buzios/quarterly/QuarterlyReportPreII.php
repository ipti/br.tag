...
<div class="pageA4H page" style="height: auto;">
    ...
    <h4>
        <?php echo Yii::t('default', 'Quarterly Report') . ' - ' . $studentIdentification?>
        </h3>
...
?>
            <p>
                <span class="pull-left">Etapa:
                    <?php echo $studentIdentification ? $studentIdentification->name : '______________________'?>
                </span>
                ...
                <h4>
                    ...
                    <table aria-labelledby="Pre Table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Identificar e representar quantidades através da linguagem verbal (objetos,
                                    desenhos, entre outros).</td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
                    ...
                    <table aria-labelledby="Pre Table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Reconta histórias ouvidas para a produção de texto escrito, endo o professor como
                                    escriba.</td>
                                <td></td>
                                <td></td>
                                <td></td>
