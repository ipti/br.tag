...
<div class="pageA4H page" style="height: auto;">
    ...
    <h4>
        <?php echo Yii::t('default', 'Quarterly Report') . ' - ' . $studentIdentification ?></h3>
        ...
        <div class="container-box header-container" style="margin-bottom: 200px;">
            ...
            ?>
            <p>
                <span class="pull-left">Etapa: <?php echo $studentIdentification ? $studentIdentification->name : '______________________' ?></span>
