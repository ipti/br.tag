...
foreach ($report as $key => $r) {
    //validacoes
    if ($r['celiac'] == 1) {
        $celiac = '<i class="fa fa-close" style="color: black"></i>';
    } else {
        $celiac = '';
    };
    if ($r['diabetes'] == 1) {
        $diabetes = '<i class="fa fa-close" style="color: black"></i>';
    } else {
        $diabetes = '';
    };
    if ($r['hypertension'] == 1) {
        $hypertension = '<i class="fa fa-close" style="color: black"></i>';
    } else {
        $hypertension = '';
    };
    if ($r['iron_deficiency_anemia'] == 1) {
        $iron_deficiency_anemia = '<i class="fa fa-close" style="color: black"></i>';
    } else {
        $iron_deficiency_anemia = '';
    };
    if ($r['sickle_cell_anemia'] == 1) {
        $sickle_cell_anemia = '<i class="fa fa-close" style="color: black"></i>';
    } else {
        $sickle_cell_anemia = '';
    };
    if ($r['lactose_intolerance'] == 1) {
        $lactose_intolerance = '<i class="fa fa-close" style="color: black"></i>';
    } else {
        $lactose_intolerance = '';
    };
    if ($r['malnutrition'] == 1) {
        $malnutrition = '<i class="fa fa-close" style="color: black"></i>';
    } else {
        $malnutrition = '';
    };
    if ($r['obesity'] == 1) {
        $obesity = '<i class="fa fa-close" style="color: black"></i>';
    } else {
        $obesity = '';
    };
