        ...
        <div class="widget-body form-horizontal">
            <div class="tab-content" style="display:none">
                <div class="tab-pane active" id="student-identify">
                    <div class="row">
                        <div class="col-md-5">
                            <div id="widget-basic" class="widget">
                                <div class="widget-head"><h4 class="heading">Dados básicos</h4></div>
                                <div class="widget-body">
                                    <div class="form-group">
                                        <?php echo $form->labelEx($modelStudentIdentification, 'name',array('class'=>'control-label')); ?>
                                        <?php echo $form->textField($modelStudentIdentification, 'name', array('size' => 60, 'maxlength' => 100,'class'=>'form-control')); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->textField($modelStudentIdentification, 'birthday', array('size' => 10, 'maxlength' => 10,'class'=>'form-control')); ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->DropDownList($modelStudentIdentification, 'sex', array(null => "Selecione o sexo", "1" => "Masculino", "2" => "Feminino"), array('class' => 'form-control select-search-off')); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->DropDownList($modelStudentIdentification, 'color_race', array(null => "Selecione a cor/raça",
                                                ...
                                                "3" => "Parda",
                                                "4" => "Amarela",
                                                "5" => "Indígena"), array('class' => 'form-control select-search-off')); ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->DropDownList($modelStudentIdentification, 'filiation', array(null => "Selecione a filiação", "0" => "Não declarado/Ignorado", "1" => "Pai e/ou Mãe"), array('class' => 'form-control select-search-off')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($modelStudentIdentification, 'filiation_1', array('size' => 60, 'maxlength' => 100,'class'=>'form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($modelStudentIdentification, 'filiation_2', array('size' => 60, 'maxlength' => 100,'class'=>'form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo $form->dropDownList($modelStudentIdentification, 'nationality', array(null => "Selecione a nacionalidade", "1" => "Brasileira", "2" => "Brasileira: Nascido no exterior ou Naturalizado", "3" => "Estrangeira"), array('class' => 'select-search-off form-control'), array('ajax' => array(
                                            'type' => 'POST',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo $form->dropDownList($modelStudentIdentification, 'edcenso_nation_fk', CHtml::listData(EdcensoNation::model()->findAll(array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione uma nação", 'class' => 'select-search-on nationality-sensitive no-br form-control', 'disabled' => 'disabled'));
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        echo $form->dropDownList($modelStudentIdentification, 'edcenso_uf_fk', CHtml::listData(EdcensoUf::model()->findAll(array('order' => 'name')), 'id', 'name'), array(
                                            ...
                                            "class" => "select-search-on nationality-sensitive br form-control",
                                            "disabled" => "disabled",
                                        ));
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        echo $form->dropDownList($modelStudentIdentification, 'edcenso_city_fk', CHtml::listData(EdcensoCity::model()->findAllByAttributes(array('edcenso_uf_fk' => $modelStudentIdentification->edcenso_uf_fk), array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione uma cidade",
                                            "disabled" => "disabled", 'class' => 'select-search-on nationality-sensitive br form-control'));
                                        ?>
                                ...
                                <div class="widget-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->DropDownList($modelStudentDocumentsAndAddress, 'residence_zone', array(null => "Selecione uma zona", "1" => "URBANA", "2" => "RURAL"), array('class' => 'select-search-off form-control')); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            echo $form->dropDownList($modelStudentDocumentsAndAddress, 'edcenso_uf_fk', CHtml::listData(EdcensoUf::model()->findAll(array('order' => 'name')), 'id', 'name'), array(
                                                ...
                                                "prompt" => "Selecione um estado",
                                                "class" => "select-search-on form-control"));
                                            ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php
                                            echo $form->dropDownList($modelStudentDocumentsAndAddress, 'edcenso_city_fk', CHtml::listData(EdcensoCity::model()->findAllByAttributes(array('edcenso_uf_fk' => $modelStudentDocumentsAndAddress->edcenso_uf_fk), array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione uma cidade", "class" => "select-search-on form-control"));
                                            ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'address', array('size' => 60, 'maxlength' => 100,'class'=>'form-control')); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'neighborhood', array('size' => 50, 'maxlength' => 50,'class'=>'form-control')); ?>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'number', array('size' => 10, 'maxlength' => 10,'class'=>'form-control')); ?>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'complement', array('size' => 20, 'maxlength' => 20,'class'=>'form-control')); ?>
                        ...
                        <div class="col-md-4">
                            <div id="widget-identification" class="widget">
                                <div class="widget-head"><h4 class="heading">Identificação</h4></div>
                                <div class="widget-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <?php echo $form->labelEx($modelStudentDocumentsAndAddress, 'nis', array('class' => 'control-label')); ?>
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'nis', array('size' => 11, 'maxlength' => 11,'class'=>'form-control')); ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->textField($modelStudentIdentification, 'inep_id', array('size' => 60, 'maxlength' => 12,'class'=>'form-control')); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'cns', array('size' => 11, 'maxlength' => 15, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'cpf', array('size' => 11, 'maxlength' => 14, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                            <?php echo $form->error($modelStudentDocumentsAndAddress, 'cpf'); ?>
                                        </div>
                                    </div>

                                    <h4 class="heading-mosaic glyphicons nameplate">
                                        Registro Geral
                                    </h4>
                                    ...
                                    <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <?php echo $form->textField($modelStudentDocumentsAndAddress, 'rg_number', array('size' => 20, 'maxlength' => 20, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <?php echo $form->textField($modelStudentDocumentsAndAddress, 'rg_number_expediction_date', array('size' => 10, 'maxlength' => 10, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->DropdownList($modelStudentDocumentsAndAddress, 'rg_number_edcenso_organ_id_emitter_fk', CHtml::listData(EdcensoOrganIdEmitter::model()->findAll(array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione um órgão emissor da identidade", "class" => "select-search-on nationality-sensitive br form-control", "disabled" => "disabled"));
                                                ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->dropDownList($modelStudentDocumentsAndAddress, 'rg_number_edcenso_uf_fk', CHtml::listData(EdcensoUf::model()->findAll(array('order' => 'name')), 'id', 'name'), array("prompt" => "Selecione um estado", "class" => "select-search-on nationality-sensitive br form-control", "disabled" => "disabled"));
                                                ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'civil_register_enrollment_number', array('size' => 32, 'maxlength' => 32, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->DropDownList($modelStudentDocumentsAndAddress, 'civil_certification', array(null => "Selecione o modelo", "1" => "Modelo Antigo", "2" => "Modelo Novo"), array("class" => "select-search-off nationality-sensitive br form-control", "disabled" => "disabled")); ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo $form->DropdownList($modelStudentDocumentsAndAddress, 'civil_certification_type', array(null => "Selecione o tipo", "1" => "Nascimento", "2" => "Casamento"), array("class" => "select-search-off nationality-sensitive br form-control", "disabled" => "disabled")); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'civil_certification_date', array('size' => 10, 'maxlength' => 10, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                        ...
                                        <div class="form-group col-md-8">
                                            <?php echo $form->labelEx($modelStudentDocumentsAndAddress, 'edcenso_notary_office_fk', array('class' => 'control-label')); ?>
                                                ...
                                                echo $form->dropDownList($modelStudentDocumentsAndAddress, 'edcenso_notary_office_fk', CHtml::listData(EdcensoNotaryOffice::model()->findAllByAttributes(array('city' => $modelStudentDocumentsAndAddress->notary_office_city_fk), array('order' => 'name')), 'cod', 'name')+array('7177'=>'OUTROS'), array("prompt" => "Selecione um cartório",
                                                    "class" => "select-search-on nationality-sensitive br form-control", "disabled" => "disabled"));
                                                ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'civil_certification_book', array('size' => 8, 'maxlength' => 8, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'civil_certification_sheet', array('size' => 4, 'maxlength' => 4, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <?php echo $form->textField($modelStudentDocumentsAndAddress, 'civil_certification_term_number', array('size' => 8, 'maxlength' => 8, "disabled" => "disabled", "class" => "nationality-sensitive br form-control")); ?>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <?php echo $form->textField($modelStudentDocumentsAndAddress, 'foreign_document_or_passport', array('size' => 20, 'maxlength' => 20, "disabled" => "disabled", "class" => "nationality-sensitive n-br form-control")); ?>
                        ...
                        <div class="col-md-3">
                            <div class="well">
                             <img src="<?php echo Yii::app()->theme->baseUrl; ?>/common/img/logo_educa_censo.png"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="student-documents">
                    <div class="row">
                        <div class="col-md-4">
                            <div id="widget-optional" class="widget">
                                <div class="widget-head"><h4 class="heading">Widget</h4></div>
                                <div class="widget-body">
                                    <div class="checkbox">
                                        <?php echo $form->labelEx($modelStudentIdentification, 'bf_participator'); ?>
                                    ...
                                    <div class="checkbox">
                                        <?php echo $form->labelEx($modelStudentIdentification, 'send_year'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textArea($modelStudentIdentification, 'food_restrictions', array('class' => 'form-control')); ?>
                                        <?php echo $form->error($modelStudentIdentification, 'food_restrictions'); ?>
                                    </div>
                                </div>
                            </div>
                            <div id="widget-deficiency"  class="widget " data-toggle="collapse-widget">
                                <!-- Widget heading -->
                                <div class="widget-head">
                                    <h4 class="heading"><?php echo Yii::t('default', 'Deficiency'); ?></h4>
                                </div>
                                <!-- // Widget heading END -->
                            ...
                            <div id="widget-resource" class="widget" data-toggle="collapse-widget" data-collapse-closed="false">

                                <!-- Widget heading -->
                                <div class="widget-head">
                                    <h4 class="heading">Recursos Prova Brasil</h4>
                                </div>
                                <!-- // Widget heading END -->
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body in" style="height: auto;">
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->DropDownList($modelStudentDocumentsAndAddress, 'justice_restriction', array(null=> "Selecione", "0" => "Não possui restrições", "1" => "LA - Liberdade Assistida", "2" => "PSC - Prestação de Serviços Comunitários"), array('class' => 'select-search-off form-control')); ?>
                        ...
                        <div class="col-md-4">
                            <div class="widget">
                                <div class="widget-head"><h4 class="heading">Dados do Responsável</h4></div>
                                <div class="widget-body">
                                    <div class="form-group">
                                        <?php echo $form->labelEx($modelStudentIdentification, 'responsable', array('class' => 'control-label')); ?>
                                        <?php
                                        echo $form->dropDownList($modelStudentIdentification, 'responsable', array(0 => 'Pai', 1 => 'Mãe', 2 => 'Outro',), array('class' => 'form-control'));
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($modelStudentIdentification, 'responsable_telephone', array('size' => 60, 'maxlength' => 15,'class' => 'form-control')); ?>
                                        <?php echo $form->error($modelStudentIdentification, 'responsable_telephone'); ?>
                                    </div>
                                    <div class="form-group" style="<?php echo (isset($modelStudentIdentification->responsable_name)) ? '': 'display:none';?>" id="responsable_name">
                                        <?php echo $form->labelEx($modelStudentIdentification, 'responsable_name', array('class' => 'control-label')); ?>
                                        <?php echo $form->textField($modelStudentIdentification, 'responsable_name', array('size' => 60, 'maxlength' => 100,'class' => 'form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($modelStudentIdentification, 'responsable_rg', array('size' => 60, 'maxlength' => 45,'class' => 'form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($modelStudentIdentification, 'responsable_cpf', array('size' => 60, 'maxlength' => 14,'class' => 'form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        echo $form->dropDownList($modelStudentIdentification, 'responsable_scholarity', array(0 => 'Não sabe ler e escrever ', 1 => 'Sabe ler e escrever', 2 => 'Ens. Fund. Incompleto',
                                            ...
                                            6 => 'Ens. Sup. Incompleto', 7 => 'Ens. Sup. Completo'), array('class' => 'select-search-off form-control'));
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($modelStudentIdentification, 'responsable_job', array('size' => 60, 'maxlength' => 100,'class'=>'form-control')); ?>
                    ...
                    <div class="row">
                                ...
                                <div class="widget-body">
                                    <div class="form-group">
                                        ...
                                        echo $form->dropDownList($modelEnrollment, 'classroom_fk',
                                            CHtml::listData(
                                                $classrooms, 'id', 'name'),
                                            array("prompt" => "Selecione uma Turma", 'class' => 'select-search-on form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->DropDownList($modelEnrollment, 'admission_type', array("1" => "Rematrícula", "2" => "Transferência interna", "3" => "Transferência externa"), array("prompt" => "Selecione", 'class' => 'select-search-off form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->DropDownList($modelEnrollment, 'another_scholarization_place', array("3" => "Não recebe", "1" => "Em hospital", "2" => "Em domicílio"), array('class' => 'select-search-off form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->DropDownList($modelEnrollment, 'status', array("1" => "Matriculado", "2" => "Transferido", "3" => "Cancelado", "4" => "Evadido"), array('class'=>'form-control','options' => array('1'=>array('selected'=>true)))); ?>
                        ...
                        <div class="col-md-4">
                            <div id="widget-optional" class="widget">
                                <div class="widget-head"><h4 class="heading">Widget</h4></div>
                                <div class="widget-body">
                                    <div class="form-group col-md-12" id="transport_responsable">
                                        <?php echo $form->labelEx($modelEnrollment, 'transport_responsable_government', array('class' => 'control-label')); ?>
                                        <?php echo $form->dropDownList($modelEnrollment, 'transport_responsable_government', array(null => "Selecione o poder público do transporte", "1" => "Estadual", "2" => "Municipal"), array('class' => 'select-search-off form-control')); ?>
                                        <?php echo $form->error($modelEnrollment, 'transport_responsable_government'); ?>
                                    </div>
                                    <div class="checkbox col-md-12">
                                        <?php echo $form->labelEx($modelEnrollment, 'public_transport'); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_bus'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_bus', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_bus'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_van'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_van', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_van'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_bike'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_bike', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_bike'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_animal_vehicle'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_animal_vehicle', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_animal_vehicle'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_other_vehicle'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_other_vehicle', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_other_vehicle'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_waterway_boat_5'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_waterway_boat_5', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_waterway_boat_5'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_microbus'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_microbus', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_microbus'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_waterway_boat_5_15'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_waterway_boat_5_15', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_waterway_boat_5_15'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_waterway_boat_15_35'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_waterway_boat_15_35', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_waterway_boat_15_35'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_waterway_boat_35'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_waterway_boat_35', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_waterway_boat_35'); ?>
                                            </div>
                                            <div class="checkbox">
                                                <?php echo $form->labelEx($modelEnrollment, 'vehicle_type_metro_or_train'); ?>
                                                <?php echo $form->checkBox($modelEnrollment, 'vehicle_type_metro_or_train', array('value' => 1, 'uncheckValue' => 0)); ?>
                                                <?php echo $form->error($modelEnrollment, 'vehicle_type_metro_or_train'); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="widget-optional" class="widget">
                                ...
                                <div class="widget-body">
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->DropDownList($modelEnrollment, 'unified_class', array(null => "Selecione o tipo de turma infantil", "1" => "CRECHE", "2" => "PRÉ-ESCOLA"), array('class' => 'select-search-off form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        <?php echo CHtml::label("Etapa", 'Stage', array('class' => 'control-label')); ?>
                                            ...
                                            echo CHtml::dropDownList("Stage", null, array(
                                                ...
                                                'class' => 'select-search-off form-control',
                                                'ajax' => array(
                                                    'type' => 'POST',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->dropDownList($modelEnrollment, 'edcenso_stage_vs_modality_fk', CHtml::listData(EdcensoStageVsModality::model()->findAll(), 'id', 'name'), array("prompt" => "Selecione a etapa", 'class' => 'select-search-on form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        <?php echo $form->labelEx($modelEnrollment, 'current_stage_situation', array('class' => 'control-label')); ?>
                                            <?php echo $form->DropDownList($modelEnrollment, 'current_stage_situation',
                                                ...
                                                array('class' => 'select-search-off form-control')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($modelEnrollment, 'school_admission_date', array('size' => 10, 'maxlength' => 10,'class'=>'form-control')); ?>
                ...
                <div class="tab-pane" id="student-historic">
                    <div class="row">
                        <div class="span11">
                            <?php
