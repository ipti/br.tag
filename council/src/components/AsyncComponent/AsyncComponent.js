...
const AsyncFoodActionComponent = Loadable({
	loader: () => import("Routes/food_action/index.js"),
	loading: () => <RctPageLoader />,
});

const AsyncFoodActionFromComponent = Loadable( {
	loader: () => import("Routes/food_action/form"),
	loading: () => <RctPageLoader />,
} );
